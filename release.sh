...
cp -av ./build-ios/edgevox-onnx.xcframework $dst/build-ios/
...
tar cjvf edgevox-onnx-v${EDGEVOX_ONNX_VERSION}-android.tar.bz2 ./jniLibs

tar cjvf edgevox-onnx-v${EDGEVOX_ONNX_VERSION}-ios.tar.bz2 ./build-ios
