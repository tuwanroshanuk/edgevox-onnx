...
# Run `pod lib lint edgevox_onnx_ios.podspec` to validate before publishing.
#
# See also
...
A new Flutter FFI plugin project.
  ...
  s.platform = :ios, '13.0'
  s.preserve_paths = 'edgevox_onnx.xcframework/**/*'
  s.vendored_frameworks = 'edgevox_onnx.xcframework'
