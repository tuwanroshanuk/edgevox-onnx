...
class SpeakerEmbeddingExtractor {
  ...
  factory SpeakerEmbeddingExtractor(
    ...
    final c = calloc<EdgevoxOnnxSpeakerEmbeddingExtractorConfig>();
    ...
    if (EdgevoxOnnxBindings.createSpeakerEmbeddingExtractor == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final ptr =
        EdgevoxOnnxBindings.createSpeakerEmbeddingExtractor?.call(c) ?? nullptr;
    ...
    final dim = EdgevoxOnnxBindings.speakerEmbeddingExtractorDim?.call(ptr) ?? 0;
  ...
  void free() {
    if (EdgevoxOnnxBindings.destroySpeakerEmbeddingExtractor == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.destroySpeakerEmbeddingExtractor?.call(ptr);
    ptr = nullptr;
  }

  /// Create an input stream for embedding extraction.
  OnlineStream createStream() {
    if (EdgevoxOnnxBindings.speakerEmbeddingExtractorCreateStream == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final p =
        EdgevoxOnnxBindings.speakerEmbeddingExtractorCreateStream?.call(ptr) ??
            nullptr;
  ...
  bool isReady(OnlineStream stream) {
    if (EdgevoxOnnxBindings.speakerEmbeddingExtractorIsReady == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int ready = EdgevoxOnnxBindings.speakerEmbeddingExtractorIsReady
            ?.call(ptr, stream.ptr) ??
        0;
    return ready == 1;
  }
  ...
  Float32List compute(OnlineStream stream) {
    if (EdgevoxOnnxBindings.speakerEmbeddingExtractorComputeEmbedding == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final Pointer<Float> embedding = EdgevoxOnnxBindings
    ...
    EdgevoxOnnxBindings.speakerEmbeddingExtractorDestroyEmbedding
        ?.call(embedding);

    return ans;
  }

  Pointer<EdgevoxOnnxSpeakerEmbeddingExtractor> ptr;
  final int dim;
}
...
class SpeakerEmbeddingManager {
  ...
  factory SpeakerEmbeddingManager(int dim) {
    if (EdgevoxOnnxBindings.createSpeakerEmbeddingManager == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final p =
        EdgevoxOnnxBindings.createSpeakerEmbeddingManager?.call(dim) ?? nullptr;
  ...
  void free() {
    if (EdgevoxOnnxBindings.destroySpeakerEmbeddingManager == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.destroySpeakerEmbeddingManager?.call(ptr);
    ptr = nullptr;
  }
  ...
  bool add({required String name, required Float32List embedding}) {
    ...
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerAdd == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int ok =
        EdgevoxOnnxBindings.speakerEmbeddingManagerAdd?.call(ptr, namePtr, p) ??
            0;
  ...
  bool addMulti(
    ...
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerAddListFlattened == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int ok = EdgevoxOnnxBindings.speakerEmbeddingManagerAddListFlattened
  ...
  bool contains(String name) {
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerContains == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int found = EdgevoxOnnxBindings.speakerEmbeddingManagerContains
            ?.call(ptr, namePtr) ??
        0;
  ...
  bool remove(String name) {
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerRemove == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int ok =
        EdgevoxOnnxBindings.speakerEmbeddingManagerRemove?.call(ptr, namePtr) ??
            0;
  ...
  String search({required Float32List embedding, required double threshold}) {
    ...
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerSearch == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final Pointer<Utf8> name = EdgevoxOnnxBindings.speakerEmbeddingManagerSearch
    ...
    EdgevoxOnnxBindings.speakerEmbeddingManagerFreeSearch?.call(name);
  ...
  bool verify(
    ...
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerVerify == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int ok = EdgevoxOnnxBindings.speakerEmbeddingManagerVerify
  ...
  int get numSpeakers {
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerNumSpeakers == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    return EdgevoxOnnxBindings.speakerEmbeddingManagerNumSpeakers?.call(ptr) ??
        0;
  }

  List<String> get allSpeakerNames {
    if (EdgevoxOnnxBindings.speakerEmbeddingManagerGetAllSpeakers == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final Pointer<Pointer<Utf8>> names =
        EdgevoxOnnxBindings.speakerEmbeddingManagerGetAllSpeakers?.call(ptr) ??
            nullptr;
    ...
    EdgevoxOnnxBindings.speakerEmbeddingManagerFreeAllSpeakers?.call(names);

    return ans;
  }

  Pointer<EdgevoxOnnxSpeakerEmbeddingManager> ptr;
  final int dim;
}
