...
///     model: './edgevox-onnx-pocket-tts/model.int8.onnx',
///     tokens: './edgevox-onnx-pocket-tts/tokens.txt',
///     dataDir: './edgevox-onnx-pocket-tts/espeak-ng-data',
///   ),
///   numThreads: 1,
/// );
///
...
class OfflineTtsGenerationConfig {
  ...
  Pointer<EdgevoxOnnxGenerationConfig> toNative() {
    final p = calloc<EdgevoxOnnxGenerationConfig>();
  ...
  void freeNative(Pointer<EdgevoxOnnxGenerationConfig> p) {
...
class OfflineTts {
  ...
  factory OfflineTts(OfflineTtsConfig config) {
    if (EdgevoxOnnxBindings.createOfflineTts == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final c = calloc<EdgevoxOnnxOfflineTtsConfig>();
    ...
    final ptr = EdgevoxOnnxBindings.createOfflineTts?.call(c) ?? nullptr;
  ...
  void free() {
    if (EdgevoxOnnxBindings.destroyOfflineTts == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.destroyOfflineTts?.call(ptr);
    ptr = nullptr;
  }
  ...
  GeneratedAudio generateWithConfig({
    ...
    if (EdgevoxOnnxBindings.offlineTtsGenerateWithConfig == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    NativeCallable<EdgevoxOnnxGeneratedAudioProgressCallbackWithArgNative>?
    wrapper;

    if (onProgress != null) {
      wrapper =
          NativeCallable<
            EdgevoxOnnxGeneratedAudioProgressCallbackWithArgNative
          >.isolateLocal((
    ...
    final p =
        EdgevoxOnnxBindings.offlineTtsGenerateWithConfig?.call(
          ptr,
          textPtr,
          cfgPtr,
    ...
    EdgevoxOnnxBindings.destroyOfflineTtsGeneratedAudio?.call(p);
  ...
  int get sampleRate {
    if (EdgevoxOnnxBindings.offlineTtsSampleRate == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    return EdgevoxOnnxBindings.offlineTtsSampleRate?.call(ptr) ?? 0;
  }

  /// Return the number of built-in speakers reported by the model.
  int get numSpeakers {
    if (EdgevoxOnnxBindings.offlineTtsNumSpeakers == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    return EdgevoxOnnxBindings.offlineTtsNumSpeakers?.call(ptr) ?? 0;
  }

  Pointer<EdgevoxOnnxOfflineTts> ptr;
