...
class OfflineRecognizer {
  ...
  void free() {
    if (EdgevoxOnnxBindings.destroyOfflineRecognizer == null) {
    ...
    EdgevoxOnnxBindings.destroyOfflineRecognizer?.call(ptr);
    ptr = nullptr;
  }
  ...
  factory OfflineRecognizer(OfflineRecognizerConfig config) {
    ...
    if (EdgevoxOnnxBindings.createOfflineRecognizer == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final ptr = EdgevoxOnnxBindings.createOfflineRecognizer?.call(c) ?? nullptr;
  ...
  void setConfig(OfflineRecognizerConfig config) {
    if (EdgevoxOnnxBindings.offlineRecognizerSetConfig == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.offlineRecognizerSetConfig?.call(ptr, c);

    freeConfig(c);
    // we don't update this.config
  }

  static Pointer<EdgevoxOnnxOfflineRecognizerConfig> convertConfig(
    OfflineRecognizerConfig config,
  ) {
    final c = calloc<EdgevoxOnnxOfflineRecognizerConfig>();
  ...
  static void freeConfig(Pointer<EdgevoxOnnxOfflineRecognizerConfig> c) {
  ...
  OfflineStream createStream() {
    if (EdgevoxOnnxBindings.createOfflineStream == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final p = EdgevoxOnnxBindings.createOfflineStream?.call(ptr) ?? nullptr;
  ...
  void decode(OfflineStream stream) {
    if (EdgevoxOnnxBindings.decodeOfflineStream == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.decodeOfflineStream?.call(ptr, stream.ptr);
  }

  /// Fetch the current recognition result for [stream].
  OfflineRecognizerResult getResult(OfflineStream stream) {
    if (EdgevoxOnnxBindings.getOfflineStreamResultAsJson == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final json =
        EdgevoxOnnxBindings.getOfflineStreamResultAsJson?.call(stream.ptr) ??
        nullptr;
    if (json == nullptr) {
      return OfflineRecognizerResult(
        text: '',
    ...
    EdgevoxOnnxBindings.destroyOfflineStreamResultJson?.call(json);
  ...
  Pointer<EdgevoxOnnxOfflineRecognizer> ptr;
  OfflineRecognizerConfig config;
}
