...
class AudioTagging {
  ...
  factory AudioTagging({required AudioTaggingConfig config}) {
    final c = calloc<EdgevoxOnnxAudioTaggingConfig>();
    ...
    if (EdgevoxOnnxBindings.edgevoxOnnxCreateAudioTagging == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final ptr =
        EdgevoxOnnxBindings.edgevoxOnnxCreateAudioTagging?.call(c) ?? nullptr;
  ...
  void free() {
    if (EdgevoxOnnxBindings.edgevoxOnnxDestroyAudioTagging == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.edgevoxOnnxDestroyAudioTagging?.call(ptr);
    ptr = nullptr;
  }

  /// Create an offline stream for one audio clip.
  OfflineStream createStream() {
    if (EdgevoxOnnxBindings.edgevoxOnnxAudioTaggingCreateOfflineStream == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final p = EdgevoxOnnxBindings.edgevoxOnnxAudioTaggingCreateOfflineStream
            ?.call(ptr) ??
        nullptr;
  ...
  List<AudioEvent> compute({required OfflineStream stream, required int topK}) {
    if (EdgevoxOnnxBindings.edgevoxOnnxAudioTaggingCompute == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final pp = EdgevoxOnnxBindings.edgevoxOnnxAudioTaggingCompute
    ...
    EdgevoxOnnxBindings.edgevoxOnnxAudioTaggingFreeResults?.call(pp);

    return ans;
  }

  Pointer<EdgevoxOnnxAudioTagging> ptr;
