...
class KeywordSpotter {
  ...
  factory KeywordSpotter(KeywordSpotterConfig config) {
    final c = calloc<EdgevoxOnnxKeywordSpotterConfig>();
    ...
    if (EdgevoxOnnxBindings.createKeywordSpotter == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final ptr = EdgevoxOnnxBindings.createKeywordSpotter?.call(c) ?? nullptr;
  ...
  void free() {
    if (EdgevoxOnnxBindings.destroyKeywordSpotter == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.destroyKeywordSpotter?.call(ptr);
    ptr = nullptr;
  }
  ...
  OnlineStream createStream({String keywords = ''}) {
    if (keywords == '') {
      if (EdgevoxOnnxBindings.createKeywordStream == null) {
        throw Exception("Please initialize edgevox-onnx first");
      }
    } else {
      if (EdgevoxOnnxBindings.createKeywordStreamWithKeywords == null) {
        throw Exception("Please initialize edgevox-onnx first");
      }
    }
    ...
    if (keywords == '') {
      final p = EdgevoxOnnxBindings.createKeywordStream?.call(ptr) ?? nullptr;
      if (p == nullptr) {
        throw Exception("Failed to create online stream");
      }
    ...
    final p =
        EdgevoxOnnxBindings.createKeywordStreamWithKeywords?.call(ptr, utf8) ??
            nullptr;
    calloc.free(utf8);
  ...
  bool isReady(OnlineStream stream) {
    if (EdgevoxOnnxBindings.isKeywordStreamReady == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    int ready =
        EdgevoxOnnxBindings.isKeywordStreamReady?.call(ptr, stream.ptr) ?? 0;
  ...
  KeywordResult getResult(OnlineStream stream) {
    if (EdgevoxOnnxBindings.getKeywordResultAsJson == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final json =
        EdgevoxOnnxBindings.getKeywordResultAsJson?.call(ptr, stream.ptr) ??
            nullptr;
    if (json == nullptr) {
      return KeywordResult(keyword: '');
    }
    ...
    EdgevoxOnnxBindings.freeKeywordResultJson?.call(json);
  ...
  void decode(OnlineStream stream) {
    if (EdgevoxOnnxBindings.decodeKeywordStream == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.decodeKeywordStream?.call(ptr, stream.ptr);
  }

  /// Reset the internal state for [stream].
  void reset(OnlineStream stream) {
    if (EdgevoxOnnxBindings.resetKeywordStream == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.resetKeywordStream?.call(ptr, stream.ptr);
  }

  Pointer<EdgevoxOnnxKeywordSpotter> ptr;
