...
class CircularBuffer {
  ...
  factory CircularBuffer({required int capacity}) {
    ...
    if (EdgevoxOnnxBindings.createCircularBuffer == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final p =
        EdgevoxOnnxBindings.createCircularBuffer?.call(capacity) ?? nullptr;
  ...
  void free() {
    if (EdgevoxOnnxBindings.destroyCircularBuffer == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.destroyCircularBuffer?.call(ptr);
    ptr = nullptr;
  }

  /// Append samples to the tail of the buffer.
  void push(Float32List data) {
    if (EdgevoxOnnxBindings.circularBufferPush == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.circularBufferPush?.call(ptr, p, n);
  ...
  Float32List get({required int startIndex, required int n}) {
    if (EdgevoxOnnxBindings.circularBufferGet == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final Pointer<Float> p =
        EdgevoxOnnxBindings.circularBufferGet?.call(ptr, startIndex, n) ??
            nullptr;
    ...
    EdgevoxOnnxBindings.circularBufferFree?.call(p);
  ...
  void pop(int n) {
    if (EdgevoxOnnxBindings.circularBufferPop == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.circularBufferPop?.call(ptr, n);
  }

  /// Clear the buffer contents.
  /// Reset the detector state.
  void reset() {
    if (EdgevoxOnnxBindings.circularBufferReset == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.circularBufferReset?.call(ptr);
  }

  int get size {
    if (EdgevoxOnnxBindings.circularBufferSize == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    return EdgevoxOnnxBindings.circularBufferSize?.call(ptr) ?? 0;
  }

  int get head {
    if (EdgevoxOnnxBindings.circularBufferHead == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    return EdgevoxOnnxBindings.circularBufferHead?.call(ptr) ?? 0;
  }

  Pointer<EdgevoxOnnxCircularBuffer> ptr;
}
...
class VoiceActivityDetector {
  ...
  factory VoiceActivityDetector(
    ...
    if (EdgevoxOnnxBindings.createVoiceActivityDetector == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final c = calloc<EdgevoxOnnxVadModelConfig>();
    ...
    final ptr = EdgevoxOnnxBindings.createVoiceActivityDetector
  ...
  void free() {
    if (EdgevoxOnnxBindings.destroyVoiceActivityDetector == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.destroyVoiceActivityDetector?.call(ptr);
    ptr = nullptr;
  }

  /// Feed normalized waveform samples into the detector.
  void acceptWaveform(Float32List samples) {
    if (EdgevoxOnnxBindings.voiceActivityDetectorAcceptWaveform == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.voiceActivityDetectorAcceptWaveform?.call(ptr, p, n);
  ...
  bool isEmpty() {
    if (EdgevoxOnnxBindings.voiceActivityDetectorEmpty == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int empty =
        EdgevoxOnnxBindings.voiceActivityDetectorEmpty?.call(ptr) ?? 0;
  ...
  bool isDetected() {
    if (EdgevoxOnnxBindings.voiceActivityDetectorDetected == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final int detected =
        EdgevoxOnnxBindings.voiceActivityDetectorDetected?.call(ptr) ?? 0;
  ...
  void pop() {
    if (EdgevoxOnnxBindings.voiceActivityDetectorPop == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.voiceActivityDetectorPop?.call(ptr);
  }

  /// Remove all queued speech segments.
  void clear() {
    if (EdgevoxOnnxBindings.voiceActivityDetectorClear == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.voiceActivityDetectorClear?.call(ptr);
  }

  /// Return the front queued speech segment.
  SpeechSegment front() {
    if (EdgevoxOnnxBindings.voiceActivityDetectorFront == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final Pointer<EdgevoxOnnxSpeechSegment> segment =
        EdgevoxOnnxBindings.voiceActivityDetectorFront?.call(ptr) ?? nullptr;
    if (segment == nullptr) {
      return SpeechSegment(samples: Float32List(0), start: 0);
    }
    ...
    EdgevoxOnnxBindings.destroySpeechSegment?.call(segment);

    return SpeechSegment(samples: samples, start: start);
  }

  void reset() {
    if (EdgevoxOnnxBindings.voiceActivityDetectorReset == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.voiceActivityDetectorReset?.call(ptr);
  }

  /// Flush trailing buffered speech into the output queue.
  void flush() {
    if (EdgevoxOnnxBindings.voiceActivityDetectorFlush == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.voiceActivityDetectorFlush?.call(ptr);
  }

  Pointer<EdgevoxOnnxVoiceActivityDetector> ptr;
