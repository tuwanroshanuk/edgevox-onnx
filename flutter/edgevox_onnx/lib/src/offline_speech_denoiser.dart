...
class OfflineSpeechDenoiser {
  ...
  factory OfflineSpeechDenoiser(OfflineSpeechDenoiserConfig config) {
    if (EdgevoxOnnxBindings.edgevoxOnnxCreateOfflineSpeechDenoiser == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final c = calloc<EdgevoxOnnxOfflineSpeechDenoiserConfig>();
    ...
    final ptr =
        EdgevoxOnnxBindings.edgevoxOnnxCreateOfflineSpeechDenoiser?.call(c) ??
            nullptr;
  ...
  void free() {
    if (EdgevoxOnnxBindings.edgevoxOnnxDestroyOfflineSpeechDenoiser == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.edgevoxOnnxDestroyOfflineSpeechDenoiser?.call(ptr);
    ptr = nullptr;
  }

  /// Denoise one chunk or a complete waveform.
  DenoisedAudio run({required Float32List samples, required int sampleRate}) {
    if (EdgevoxOnnxBindings.edgevoxOnnxOfflineSpeechDenoiserRun == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final p = EdgevoxOnnxBindings.edgevoxOnnxOfflineSpeechDenoiserRun
  ...
  int get sampleRate {
    if (EdgevoxOnnxBindings.edgevoxOnnxOfflineSpeechDenoiserGetSampleRate ==
        null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    return EdgevoxOnnxBindings.edgevoxOnnxOfflineSpeechDenoiserGetSampleRate
            ?.call(ptr) ??
        0;
  }

  Pointer<EdgevoxOnnxOfflineSpeechDenoiser> ptr;
