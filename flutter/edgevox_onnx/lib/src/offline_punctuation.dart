...
class OfflinePunctuation {
  ...
  factory OfflinePunctuation({required OfflinePunctuationConfig config}) {
    if (EdgevoxOnnxBindings.edgevoxOnnxCreateOfflinePunctuation == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }

    final c = calloc<EdgevoxOnnxOfflinePunctuationConfig>();
    ...
    final ptr =
        EdgevoxOnnxBindings.edgevoxOnnxCreateOfflinePunctuation?.call(c) ??
            nullptr;
  ...
  void free() {
    if (EdgevoxOnnxBindings.edgevoxOnnxDestroyOfflinePunctuation == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    EdgevoxOnnxBindings.edgevoxOnnxDestroyOfflinePunctuation?.call(ptr);
    ptr = nullptr;
  }

  /// Add punctuation to [text].
  String addPunct(String text) {
    if (EdgevoxOnnxBindings.sherpaOfflinePunctuationAddPunct == null) {
      throw Exception("Please initialize edgevox-onnx first");
    }
    ...
    final p = EdgevoxOnnxBindings.sherpaOfflinePunctuationAddPunct
            ?.call(ptr, textPtr) ??
        nullptr;
    ...
    EdgevoxOnnxBindings.sherpaOfflinePunctuationFreeText?.call(p);

    return ans;
  }

  Pointer<EdgevoxOnnxOfflinePunctuation> ptr;
