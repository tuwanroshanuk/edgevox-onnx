...
public class NonStreamingDecodeFileFireRedAsr {
  public static void main(String[] args) {
    ...
    String encoder = "./edgevox-onnx-fire-red-asr-large-zh_en-2025-02-16/encoder.int8.onnx";
    String decoder = "./edgevox-onnx-fire-red-asr-large-zh_en-2025-02-16/decoder.int8.onnx";
    String tokens = "./edgevox-onnx-fire-red-asr-large-zh_en-2025-02-16/tokens.txt";

    String waveFilename = "./edgevox-onnx-fire-red-asr-large-zh_en-2025-02-16/test_wavs/0.wav";
