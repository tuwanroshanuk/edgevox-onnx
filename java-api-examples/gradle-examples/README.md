# edgevox-onnx Gradle Example

This directory demonstrates how to use [edgevox-onnx](https://github.com/k2-fsa/edgevox-onnx) via Gradle.
...
unzip -l build/libs/edgevox-onnx-gradle-example.jar | grep -E "\.so$|\.dylib$|\.dll$"
```
