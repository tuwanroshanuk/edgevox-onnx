...
if [ ! -d ./edgevox-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20 ]; then
  ...
  echo ""
  echo "https://k2-fsa.github.io/sherpa/onnx/pretrained_models/zipformer-transducer-models.html#edgevox-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20-bilingual-chinese-english"
  echo ""
  echo "for help"
...
if [ ! -e ./decode-file ]; then
  ...
  swiftc \
    ...
    ./decode-file.swift  ./EdgevoxOnnx.swift \
