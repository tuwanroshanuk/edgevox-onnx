...
static Napi::External<EdgevoxOnnxOfflineSpeechDenoiser>
CreateOfflineSpeechDenoiserWrapper(const Napi::CallbackInfo &info) {
  ...
  EdgevoxOnnxOfflineSpeechDenoiserConfig c;
  memset(&c, 0, sizeof(c));
  ...
  const EdgevoxOnnxOfflineSpeechDenoiser *sd =
      EdgevoxOnnxCreateOfflineSpeechDenoiserOHOS(&c, mgr.get());
#else
  const EdgevoxOnnxOfflineSpeechDenoiser *sd =
      EdgevoxOnnxCreateOfflineSpeechDenoiser(&c);
#endif
  ...
  return Napi::External<EdgevoxOnnxOfflineSpeechDenoiser>::New(
      env, const_cast<EdgevoxOnnxOfflineSpeechDenoiser *>(sd),
      [](Napi::Env env, EdgevoxOnnxOfflineSpeechDenoiser *sd) {
...
static Napi::Object OfflineSpeechDenoiserRunWrapper(
  ...
  const EdgevoxOnnxOfflineSpeechDenoiser *sd =
      info[0].As<Napi::External<EdgevoxOnnxOfflineSpeechDenoiser>>().Data();
  ...
  audio = EdgevoxOnnxOfflineSpeechDenoiserRun(
...
static Napi::Number OfflineSpeechDenoiserGetSampleRateWrapper(
  ...
  int32_t sample_rate = EdgevoxOnnxOfflineSpeechDenoiserGetSampleRate(sd);
