...
#ifndef EDGEVOX_ONNX_HARMONY_OS_EDGEVOXONNXHAR_EDGEVOX_ONNX_SRC_MAIN_CPP_SPEECH_DENOISER_H_
#define EDGEVOX_ONNX_HARMONY_OS_EDGEVOXONNXHAR_EDGEVOX_ONNX_SRC_MAIN_CPP_SPEECH_DENOISER_H_
...
static inline EdgevoxOnnxOfflineSpeechDenoiserGtcrnModelConfig
GetSpeechDenoiserGtcrnModelConfig(Napi::Object obj) {
  EdgevoxOnnxOfflineSpeechDenoiserGtcrnModelConfig c;
  memset(&c, 0, sizeof(c));
...
static inline EdgevoxOnnxOfflineSpeechDenoiserDpdfNetModelConfig
GetSpeechDenoiserDpdfNetModelConfig(Napi::Object obj) {
  EdgevoxOnnxOfflineSpeechDenoiserDpdfNetModelConfig c;
  memset(&c, 0, sizeof(c));
...
static inline EdgevoxOnnxOfflineSpeechDenoiserModelConfig
GetSpeechDenoiserModelConfig(Napi::Object obj) {
  EdgevoxOnnxOfflineSpeechDenoiserModelConfig c;
  memset(&c, 0, sizeof(c));
...
static inline void DeleteSpeechDenoiserModelConfig(
    const EdgevoxOnnxOfflineSpeechDenoiserModelConfig &c) {
  EDGEVOX_ONNX_DELETE_C_STR(c.gtcrn.model);
  EDGEVOX_ONNX_DELETE_C_STR(c.provider);
  EDGEVOX_ONNX_DELETE_C_STR(c.dpdfnet.model);
}
...
static inline Napi::Object CreateDenoisedAudioObject(
    Napi::Env env, const EdgevoxOnnxDenoisedAudio *audio,
  ...
  if (enable_external_buffer) {
    Napi::ArrayBuffer arrayBuffer = Napi::ArrayBuffer::New(
        ...
        [](Napi::Env /*env*/, void * /*data*/,
           const EdgevoxOnnxDenoisedAudio *hint) {
          EdgevoxOnnxDestroyDenoisedAudio(hint);
        },
        audio);
...
#endif  // EDGEVOX_ONNX_HARMONY_OS_EDGEVOXONNXHAR_EDGEVOX_ONNX_SRC_MAIN_CPP_SPEECH_DENOISER_H_
