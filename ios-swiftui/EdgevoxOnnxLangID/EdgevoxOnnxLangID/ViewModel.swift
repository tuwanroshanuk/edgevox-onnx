...
class ViewModel:ObservableObject {
    ...
    var languageIdentifier: EdgevoxOnnxSpokenLanguageIdentificationWrapper? = nil
    ...
    private func initRecognizer() {
        ...
        self.languageIdentifier = EdgevoxOnnxSpokenLanguageIdentificationWrapper(config: &config)
    }
