...
class SubtitleViewModel: ObservableObject {
    ...
    var vad: EdgevoxOnnxVoiceActivityDetectorWrapper?
    ...
    init() {
        ...
        let sileroVadConfig = edgevoxOnnxSileroVadModelConfig(
            model: getResource("silero_vad", "onnx")
        )

        self.vadModelConfig = edgevoxOnnxVadModelConfig(sileroVad: sileroVadConfig)
        guard var vadModelConfig else {
            return
        }
        vad = EdgevoxOnnxVoiceActivityDetectorWrapper(
