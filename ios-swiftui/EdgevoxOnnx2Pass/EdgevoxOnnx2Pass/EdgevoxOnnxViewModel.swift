...
class EdgevoxOnnxViewModel: ObservableObject {
    ...
    var recognizer: EdgevoxOnnxRecognizer! = nil
    var offlineRecognizer: EdgevoxOnnxOfflineRecognizer! = nil
    ...
    private func initRecognizer() {
        ...
        recognizer = EdgevoxOnnxRecognizer(config: &config)
    }
    ...
    private func initOfflineRecognizer() {
        ...
        offlineRecognizer = EdgevoxOnnxOfflineRecognizer(config: &config)
    }
