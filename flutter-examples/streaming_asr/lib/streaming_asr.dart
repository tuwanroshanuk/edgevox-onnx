...
Future<edgevox_onnx.OnlineRecognizer> createOnlineRecognizer() async {
  final type = 0;
  ...
  return edgevox_onnx.OnlineRecognizer(config);
}
...
class _StreamingAsrScreenState extends State<StreamingAsrScreen> {
  ...
  edgevox_onnx.OnlineRecognizer? _recognizer;
  edgevox_onnx.OnlineStream? _stream;
