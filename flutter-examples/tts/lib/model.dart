...
Future<edgevox_onnx.OfflineTts> createOfflineTts() async {
  // edgevox_onnx requires that model files are in the local disk, so we
  ...
  late final edgevox_onnx.OfflineTtsVitsModelConfig vits;
  late final edgevox_onnx.OfflineTtsKokoroModelConfig kokoro;
  late final edgevox_onnx.OfflineTtsKittenModelConfig kitten;

  if (isKitten) {
    vits = edgevox_onnx.OfflineTtsVitsModelConfig();
    kokoro = edgevox_onnx.OfflineTtsKokoroModelConfig();
    kitten = edgevox_onnx.OfflineTtsKittenModelConfig(
      model: modelName,
      voices: voices,
      tokens: tokens,
      dataDir: dataDir,
