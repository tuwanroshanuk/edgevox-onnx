...
This directory contains flutter examples of `edgevox-onnx`.
...
│ /Users/fangjun/open-source/edgevox-onnx/flutter-examples/streaming_asr/android/app/build.gradle:                 │
│ android {                                                                                                       │
│   defaultConfig {                                                                                               │
│     minSdkVersion 23                                                                                            │
│   }                                                                                                             │
...
ERROR:/Users/fangjun/open-source/edgevox-onnx/flutter-examples/streaming_asr/build/record_android/intermediates/runtime_library_classes_jar/debug/clas
...
=androidJvm}.
      > Execution failed for DexingWithClasspathTransform: /Users/fangjun/open-source/edgevox-onnx/flutter-examples/streaming_asr/build/record_android
...
If it shows the following log after pressing `start` within the edgevox-onnx APP on your iPhone:
