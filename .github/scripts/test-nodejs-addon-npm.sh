...
curl -SL -O https://github.com/k2-fsa/edgevox-onnx/releases/download/asr-models/edgevox-onnx-nemo-parakeet-tdt-0.6b-v2-int8.tar.bz2
...
rm -rf edgevox-onnx-nemo-parakeet-tdt-0.6b-v2-int8
...
rm -rfv *.onnx *.wav edgevox-onnx-pyannote-*
...
if [[ $arch != "ia32" && $platform != "win32" ]]; then
  ...
  rm -rf edgevox-onnx-nemo-fast-conformer-ctc-be-de-en-es-fr-hr-it-pl-ru-uk-20k
...
curl -SL -O https://github.com/k2-fsa/edgevox-onnx/releases/download/tts-models/edgevox-onnx-vits-zh-ll.tar.bz2
...
if [[ $arch != "ia32" && $platform != "win32" && $node_version != 21 ]]; then
  ...
  rm -rf edgevox-onnx-online-punct-en-2024-08-06.tar.bz2
fi
...
rm -rf edgevox-onnx-zipformer-en-2023-04-01
