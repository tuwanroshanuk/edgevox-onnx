...
for m in ${models[@]}; do
  curl -LS -O https://github.com/k2-fsa/edgevox-onnx/releases/download/speaker-recongition-models/$m
  curl -LS -O https://github.com/k2-fsa/edgevox-onnx/releases/download/speaker-recongition-models/wespeaker_en_voxceleb_CAM++_LM.onnx
done
ls -lh
popd
...
python3 edgevox-onnx/python/tests/test_speaker_recognition.py --verbose
