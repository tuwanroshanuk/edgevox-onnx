...
def main():
    ...
    clustering_config = edgevox_onnx.FastClusteringConfig(num_clusters=2)
    #  clustering_config = edgevox_onnx.FastClusteringConfig(threshold=0.8)
    clustering = edgevox_onnx.FastClustering(clustering_config)
