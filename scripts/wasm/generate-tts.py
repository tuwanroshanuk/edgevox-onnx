...
def get_models():
    models = [
        ...
        Model(
            ...
            git checkout .
            sed -i.bak 's/let modelType = 0/let modelType = 2/g' ../edgevox-onnx-tts.js
        ...
        Model(
            ...
            git checkout .
            sed -i.bak 's/let modelType = 0/let modelType = 3/g' ../edgevox-onnx-tts.js
        ...
        Model(
            ...
            git checkout .
            sed -i.bak 's/let modelType = 0/let modelType = 5/g' ../edgevox-onnx-tts.js
            rm -rf $model_name
            git diff
            """,
        ),
