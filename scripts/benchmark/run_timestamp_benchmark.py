...
Compares edgevox-onnx Whisper word timestamps against MFA alignments.

Usage:
    PYTHONPATH=build/lib:edgevox-onnx/python python scripts/benchmark/run_timestamp_benchmark.py \
...
try:
    ...
    print("ERROR: edgevox_onnx not found. Please install it using one of the methods at:")
...
def get_sherpa_word_timestamps(
    ...
    """Run edgevox-onnx recognition and return word timestamps."""
...
def _init_worker(encoder: str, decoder: str, tokens: str, language: str):
    ...
    _worker_recognizer = edgevox_onnx.OfflineRecognizer.from_whisper(
        encoder=encoder,
        decoder=decoder,
        tokens=tokens,
        language=language,
