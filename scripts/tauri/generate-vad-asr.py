...
"""
Generate build artifacts for the edgevox-onnx Tauri VAD+ASR desktop apps.
    ...
    return [
        Model(
            ...
            if [ ! -f itn_zh_number.fst ]; then
              curl -fSL -O https://github.com/k2-fsa/edgevox-onnx/releases/download/asr-models/itn_zh_number.fst
            fi
        ...
        Model(
            model_name="edgevox-onnx-whisper-base.en",
            idx=3,
            lang="en",
            lang2="English",
        ...
        Model(
            model_name="edgevox-onnx-zipformer-multi-zh-hans-2023-9-2",
            idx=5,
            lang="zh",
            lang2="Chinese",
            short_name="zipformer",
        ...
        Model(
            model_name="edgevox-onnx-nemo-ctc-en-citrinet-512",
            idx=6,
            lang="en",
            lang2="English",
            short_name="nemo_ctc",
        ...
        Model(
            model_name="edgevox-onnx-small-zipformer-ru-2024-09-18",
            idx=18,
            lang="ru",
            lang2="Russian",
        ...
        Model(
            model_name="edgevox-onnx-fire-red-asr-large-zh_en-2025-02-16",
            idx=24,
            lang="zh_en",
            lang2="Chinese,English",
        ...
        Model(
            model_name="edgevox-onnx-nemo-canary-180m-flash-en-es-de-fr-int8",
            idx=32,
            lang="en_es_de_fr",
        ...
        Model(
            model_name="edgevox-onnx-wenetspeech-wu-u2pp-conformer-ctc-zh-int8-2026-02-03",
            idx=47,
            lang="zh",
        ...
        Model(
            model_name="edgevox-onnx-wenetspeech-wu-u2pp-conformer-ctc-zh-2026-02-03",
            idx=48,
            lang="zh",
            lang2="Chinese (Wu dialect)",
