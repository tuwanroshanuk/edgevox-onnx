...
cp -v /edgevox-onnx/scripts/zipformer-transducer/x-asr/test_onnx_streaming.py punct/test_onnx.py
cp -v /edgevox-onnx/scripts/zipformer-transducer/x-asr/test_onnx_streaming.py no-punct/test_onnx.py
