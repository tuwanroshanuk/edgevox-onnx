...
namespace EdgevoxOnnx
{
    public class DenoisedAudio
    {
        ...
        private static bool WriteWave(IntPtr samples, int numSamples, int sampleRate, String filename)
        {
            ...
            int status = EdgevoxOnnxWriteWave(samples, numSamples, sampleRate, utf8FilenameWithNull);
            return status == 1;
        }
        ...
        private void Cleanup()
        {
            if (Handle != IntPtr.Zero)
            {
                EdgevoxOnnxDestroyDenoisedAudio(Handle);
            }
        ...
        private static extern void EdgevoxOnnxDestroyDenoisedAudio(IntPtr handle);
