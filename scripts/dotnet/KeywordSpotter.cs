...
namespace EdgevoxOnnx
{
    ...
    public class KeywordSpotter : IDisposable
    {
        ...
        {
            IntPtr h = EdgevoxOnnxCreateKeywordSpotter(ref config);
            _handle = new HandleRef(this, h);
        }

        public OnlineStream CreateStream()
        {
            IntPtr p = EdgevoxOnnxCreateKeywordStream(_handle.Handle);
        ...
        public OnlineStream CreateStream(string keywords)
        {
            ...
            IntPtr p = EdgevoxOnnxCreateKeywordStreamWithKeywords(_handle.Handle, utf8BytesWithNull);
            return new OnlineStream(p);
        }
        ...
        {
            EdgevoxOnnxDestroyKeywordSpotter(_handle.Handle);
        ...
        private static extern IntPtr EdgevoxOnnxCreateKeywordSpotter(ref KeywordSpotterConfig config);

        [DllImport(Dll.Filename)]
        private static extern void EdgevoxOnnxDestroyKeywordSpotter(IntPtr handle);

        [DllImport(Dll.Filename)]
        private static extern IntPtr EdgevoxOnnxCreateKeywordStream(IntPtr handle);

        [DllImport(Dll.Filename)]
        private static extern IntPtr EdgevoxOnnxCreateKeywordStreamWithKeywords(IntPtr handle, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.I1)] byte[] utf8Keywords);

        [DllImport(Dll.Filename, EntryPoint = "EdgevoxOnnxIsKeywordStreamReady")]
        private static extern int IsReady(IntPtr handle, IntPtr stream);

        [DllImport(Dll.Filename, EntryPoint = "EdgevoxOnnxDecodeKeywordStream")]
        private static extern void Decode(IntPtr handle, IntPtr stream);

        [DllImport(Dll.Filename, EntryPoint = "EdgevoxOnnxResetKeywordStream")]
        private static extern void Reset(IntPtr handle, IntPtr stream);

        [DllImport(Dll.Filename, EntryPoint = "EdgevoxOnnxDecodeMultipleKeywordStreams")]
        private static extern void Decode(IntPtr handle, IntPtr[] streams, int n);

        [DllImport(Dll.Filename, EntryPoint = "EdgevoxOnnxGetKeywordResult")]
        private static extern IntPtr GetResult(IntPtr handle, IntPtr stream);

        [DllImport(Dll.Filename, EntryPoint = "EdgevoxOnnxDestroyKeywordResult")]
