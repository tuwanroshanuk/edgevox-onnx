...
namespace EdgevoxOnnx
{
    public class OfflinePunctuation : IDisposable
    {
        ...
        {
            IntPtr h = EdgevoxOnnxCreateOfflinePunctuation(ref config);
        ...
        {
            EdgevoxOnnxDestroyOfflinePunctuation(_handle.Handle);
        ...
        private static extern IntPtr EdgevoxOnnxCreateOfflinePunctuation(ref OfflinePunctuationConfig config);

        [DllImport(Dll.Filename)]
        private static extern void EdgevoxOnnxDestroyOfflinePunctuation(IntPtr handle);
