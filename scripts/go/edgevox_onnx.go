...
[edgevox-onnx] is an open-source speech recognition framework for [Next-gen Kaldi].
...
type OnlineRecognizer struct {
	impl *C.struct_EdgevoxOnnxOnlineRecognizer
}

// The online stream class. It wraps a pointer from C.
type OnlineStream struct {
	impl *C.struct_EdgevoxOnnxOnlineStream
}
...
func DeleteOnlineRecognizer(recognizer *OnlineRecognizer) {
	C.EdgevoxOnnxDestroyOnlineRecognizer(recognizer.impl)
	recognizer.impl = nil
}
...
func NewOnlineRecognizer(config *OnlineRecognizerConfig) *OnlineRecognizer {
	c := C.struct_EdgevoxOnnxOnlineRecognizerConfig{}
	...
	impl := C.EdgevoxOnnxCreateOnlineRecognizer(&c)
	if impl == nil {
		return nil
	}
...
func DeleteOnlineStream(stream *OnlineStream) {
	C.EdgevoxOnnxDestroyOnlineStream(stream.impl)
	stream.impl = nil
}
...
func NewOnlineStream(recognizer *OnlineRecognizer) *OnlineStream {
	stream := &OnlineStream{}
	stream.impl = C.EdgevoxOnnxCreateOnlineStream(recognizer.impl)
	return stream
}
...
func (s *OnlineStream) AcceptWaveform(sampleRate int, samples []float32) {
	C.EdgevoxOnnxOnlineStreamAcceptWaveform(s.impl, C.int(sampleRate), (*C.float)(&samples[0]), C.int(len(samples)))
}
...
func (s *OnlineStream) InputFinished() {
	C.EdgevoxOnnxOnlineStreamInputFinished(s.impl)
}
...
func (s *OnlineStream) SetOption(key string, value string) {
	...
	C.EdgevoxOnnxOnlineStreamSetOption(s.impl, cKey, cValue)
}
...
func (s *OnlineStream) GetOption(key string) string {
	cKey := C.CString(key)
	defer C.free(unsafe.Pointer(cKey))
	return C.GoString(C.EdgevoxOnnxOnlineStreamGetOption(s.impl, cKey))
}
...
func (s *OnlineStream) HasOption(key string) bool {
	cKey := C.CString(key)
	defer C.free(unsafe.Pointer(cKey))
	return C.EdgevoxOnnxOnlineStreamHasOption(s.impl, cKey) == 1
}
...
func (recognizer *OnlineRecognizer) IsReady(s *OnlineStream) bool {
	return C.EdgevoxOnnxIsOnlineStreamReady(recognizer.impl, s.impl) == 1
}
...
func (recognizer *OnlineRecognizer) IsEndpoint(s *OnlineStream) bool {
	return C.EdgevoxOnnxOnlineStreamIsEndpoint(recognizer.impl, s.impl) == 1
}
...
func (recognizer *OnlineRecognizer) Reset(s *OnlineStream) {
	C.EdgevoxOnnxOnlineStreamReset(recognizer.impl, s.impl)
}
...
func (recognizer *OnlineRecognizer) Decode(s *OnlineStream) {
	C.EdgevoxOnnxDecodeOnlineStream(recognizer.impl, s.impl)
}
...
func (recognizer *OnlineRecognizer) DecodeStreams(s []*OnlineStream) {
	ss := make([]*C.struct_EdgevoxOnnxOnlineStream, len(s))
	for i, v := range s {
		ss[i] = v.impl
	}

	C.EdgevoxOnnxDecodeMultipleOnlineStreams(recognizer.impl, &ss[0], C.int(len(s)))
}
...
func (recognizer *OnlineRecognizer) GetResult(s *OnlineStream) *OnlineRecognizerResult {
	p := C.EdgevoxOnnxGetOnlineStreamResult(recognizer.impl, s.impl)
	defer C.EdgevoxOnnxDestroyOnlineRecognizerResult(p)
	n := int(p.count)
...
type OfflineRecognizer struct {
	impl *C.struct_EdgevoxOnnxOfflineRecognizer
}

// It wraps a pointer from C
type OfflineStream struct {
	impl *C.struct_EdgevoxOnnxOfflineStream
}
...
func newCOfflineRecognizerConfig(config *OfflineRecognizerConfig) *C.struct_EdgevoxOnnxOfflineRecognizerConfig {
	c := C.struct_EdgevoxOnnxOfflineRecognizerConfig{}
	c.feat_config.sample_rate = C.int(config.FeatConfig.SampleRate)
	c.feat_config.feature_dim = C.int(config.FeatConfig.FeatureDim)
...
func freeCOfflineRecognizerConfig(c *C.struct_EdgevoxOnnxOfflineRecognizerConfig) {
	stringFields := []*(*C.char){
...
func DeleteOfflineRecognizer(recognizer *OfflineRecognizer) {
	C.EdgevoxOnnxDestroyOfflineRecognizer(recognizer.impl)
	recognizer.impl = nil
}
...
func NewOfflineRecognizer(config *OfflineRecognizerConfig) *OfflineRecognizer {
	...
	impl := C.EdgevoxOnnxCreateOfflineRecognizer(c)
	if impl == nil {
		return nil
	}
...
func NewOfflineStream(recognizer *OfflineRecognizer) *OfflineStream {
	...
	stream.impl = C.EdgevoxOnnxCreateOfflineStream(recognizer.impl)
	return stream
}
...
func (s *OfflineStream) AcceptWaveform(sampleRate int, samples []float32) {
	C.EdgevoxOnnxAcceptWaveformOffline(s.impl, C.int(sampleRate), (*C.float)(&samples[0]), C.int(len(samples)))
}
...
func (s *OfflineStream) SetOption(key string, value string) {
	...
	cValue := C.CString(value)
	defer C.free(unsafe.Pointer(cValue))
	C.EdgevoxOnnxOfflineStreamSetOption(s.impl, cKey, cValue)
}
...
func (s *OfflineStream) GetOption(key string) string {
	cKey := C.CString(key)
	defer C.free(unsafe.Pointer(cKey))
	return C.GoString(C.EdgevoxOnnxOfflineStreamGetOption(s.impl, cKey))
}
...
func (s *OfflineStream) HasOption(key string) bool {
	cKey := C.CString(key)
	defer C.free(unsafe.Pointer(cKey))
	return C.EdgevoxOnnxOfflineStreamHasOption(s.impl, cKey) == 1
}

// Decode the offline stream.
func (recognizer *OfflineRecognizer) Decode(s *OfflineStream) {
	C.EdgevoxOnnxDecodeOfflineStream(recognizer.impl, s.impl)
}

// Decode multiple streams in parallel, i.e., in batch.
func (recognizer *OfflineRecognizer) DecodeStreams(s []*OfflineStream) {
	ss := make([]*C.struct_EdgevoxOnnxOfflineStream, len(s))
	for i, v := range s {
		ss[i] = v.impl
	}

	C.EdgevoxOnnxDecodeMultipleOfflineStreams(recognizer.impl, &ss[0], C.int(len(s)))
}

// Get the recognition result of the offline stream.
func (s *OfflineStream) GetResult() *OfflineRecognizerResult {
	p := C.EdgevoxOnnxGetOfflineStreamResult(s.impl)
	defer C.EdgevoxOnnxDestroyOfflineRecognizerResult(p)
	n := int(p.count)
...
type OfflineTts struct {
	impl *C.struct_EdgevoxOnnxOfflineTts
}

type edgevoxOnnxGeneratedAudioCallbackWithArg func(samples []float32) bool
...
func _cgoGeneratedAudioCallback(
	...
	h := *(*cgo.Handle)(arg)
	cb := h.Value().(edgevoxOnnxGeneratedAudioCallbackWithArg)
...
type edgevoxOnnxGeneratedAudioProgressCallbackWithArg func(samples []float32, p float32) bool
...
func _cgoGeneratedAudioProgressCallback(
	...
	h := *(*cgo.Handle)(arg)
	cb := h.Value().(edgevoxOnnxGeneratedAudioProgressCallbackWithArg)
...
func DeleteOfflineTts(tts *OfflineTts) {
	C.EdgevoxOnnxDestroyOfflineTts(tts.impl)
	tts.impl = nil
}
...
func NewOfflineTts(config *OfflineTtsConfig) *OfflineTts {
	c := C.struct_EdgevoxOnnxOfflineTtsConfig{}
	...
	impl := C.EdgevoxOnnxCreateOfflineTts(&c)
	if impl == nil {
		return nil
	}
	tts := &OfflineTts{}
...
func (tts *OfflineTts) NumSpeakers() int {
	return int(C.EdgevoxOnnxOfflineTtsNumSpeakers(tts.impl))
}

func (tts *OfflineTts) SampleRate() int {
	return int(C.EdgevoxOnnxOfflineTtsSampleRate(tts.impl))
}
...
func (tts *OfflineTts) Generate(text string, sid int, speed float32) *GeneratedAudio {
	...
	var cCfg C.struct_EdgevoxOnnxGenerationConfig
	cCfg.sid = C.int(sid)
	cCfg.speed = C.float(speed)

	audio := C.EdgevoxOnnxOfflineTtsGenerateWithConfig(tts.impl, s, &cCfg, nil, nil)

	if audio == nil {
		return nil
	}

	defer C.EdgevoxOnnxDestroyOfflineTtsGeneratedAudio(audio)
...
func (tts *OfflineTts) GenerateWithCallback(
	...
	sid int,
	speed float32,
	cb edgevoxOnnxGeneratedAudioCallbackWithArg,
) *GeneratedAudio {
	cfg := &GenerationConfig{
		Speed: speed,
		Sid:   sid,
	...
	var pcb edgevoxOnnxGeneratedAudioProgressCallbackWithArg
	if cb != nil {
...
func (tts *OfflineTts) GenerateWithProgressCallback(
	...
	sid int,
	speed float32,
	cb edgevoxOnnxGeneratedAudioProgressCallbackWithArg,
) *GeneratedAudio {
	s := C.CString(text)
	defer C.free(unsafe.Pointer(s))
	...
	var audio *C.struct_EdgevoxOnnxGeneratedAudio

	if cb != nil {
		h := cgo.NewHandle(cb)
		defer h.Delete()

		audio = C.EdgevoxOnnxOfflineTtsGenerateWithConfig(
			tts.impl,
			s,
			&cCfg,
			C.EdgevoxOnnxGeneratedAudioProgressCallbackWithArg(
...
func (audio *GeneratedAudio) Save(filename string) bool {
	...
	ok := int(C.EdgevoxOnnxWriteWave((*C.float)(&audio.Samples[0]), C.int(len(audio.Samples)), C.int(audio.SampleRate), s))
...
func (audio *GeneratedAudio) ToBuffer() []byte {
	...
	// Uses the C API: EDGEVOX_ONNX_API void EdgevoxOnnxWriteWaveToBuffer(const float *samples, int32_t n, int32_t sample_rate, char *buffer);
	n := len(audio.Samples)
	if n == 0 {
		return nil
	}
	fs := C.EdgevoxOnnxWaveFileSize(C.int(n)) // EDGEVOX_ONNX_API int64_t EdgevoxOnnxWaveFileSize(int32_t n_samples);
	buf := make([]byte, fs)
	C.EdgevoxOnnxWriteWaveToBuffer((*C.float)(&audio.Samples[0]), C.int(n), C.int(audio.SampleRate), (*C.char)(unsafe.Pointer(&buf[0])))
	return buf
}
...
type CircularBuffer struct {
	impl *C.struct_EdgevoxOnnxCircularBuffer
}

func DeleteCircularBuffer(buffer *CircularBuffer) {
	C.EdgevoxOnnxDestroyCircularBuffer(buffer.impl)
	buffer.impl = nil
}

func NewCircularBuffer(capacity int) *CircularBuffer {
	circularBuffer := &CircularBuffer{}
	circularBuffer.impl = C.EdgevoxOnnxCreateCircularBuffer(C.int(capacity))
	return circularBuffer
}

func (buffer *CircularBuffer) Push(samples []float32) {
	C.EdgevoxOnnxCircularBufferPush(buffer.impl, (*C.float)(&samples[0]), C.int(len(samples)))
}

func (buffer *CircularBuffer) Get(start int, n int) []float32 {
	samples := C.EdgevoxOnnxCircularBufferGet(buffer.impl, C.int(start), C.int(n))
	defer C.EdgevoxOnnxCircularBufferFree(samples)
...
func (buffer *CircularBuffer) Pop(n int) {
	C.EdgevoxOnnxCircularBufferPop(buffer.impl, C.int(n))
}

func (buffer *CircularBuffer) Size() int {
	return int(C.EdgevoxOnnxCircularBufferSize(buffer.impl))
}

func (buffer *CircularBuffer) Head() int {
	return int(C.EdgevoxOnnxCircularBufferHead(buffer.impl))
}

func (buffer *CircularBuffer) Reset() {
	C.EdgevoxOnnxCircularBufferReset(buffer.impl)
}
...
func NewVoiceActivityDetector(config *VadModelConfig, bufferSizeInSeconds float32) *VoiceActivityDetector {
	...
	impl := C.EdgevoxOnnxCreateVoiceActivityDetector(&c, C.float(bufferSizeInSeconds))
	if impl == nil {
		return nil
	}
...
func DeleteVoiceActivityDetector(vad *VoiceActivityDetector) {
	C.EdgevoxOnnxDestroyVoiceActivityDetector(vad.impl)
	vad.impl = nil
}

func (vad *VoiceActivityDetector) AcceptWaveform(samples []float32) {
	C.EdgevoxOnnxVoiceActivityDetectorAcceptWaveform(vad.impl, (*C.float)(&samples[0]), C.int(len(samples)))
}

func (vad *VoiceActivityDetector) IsEmpty() bool {
	return int(C.EdgevoxOnnxVoiceActivityDetectorEmpty(vad.impl)) == 1
}

func (vad *VoiceActivityDetector) IsSpeech() bool {
	return int(C.EdgevoxOnnxVoiceActivityDetectorDetected(vad.impl)) == 1
}

func (vad *VoiceActivityDetector) Pop() {
	C.EdgevoxOnnxVoiceActivityDetectorPop(vad.impl)
}

func (vad *VoiceActivityDetector) Clear() {
	C.EdgevoxOnnxVoiceActivityDetectorClear(vad.impl)
}

func (vad *VoiceActivityDetector) Front() *SpeechSegment {
	f := C.EdgevoxOnnxVoiceActivityDetectorFront(vad.impl)
	defer C.EdgevoxOnnxDestroySpeechSegment(f)
...
func (vad *VoiceActivityDetector) Reset() {
	C.EdgevoxOnnxVoiceActivityDetectorReset(vad.impl)
}

func (vad *VoiceActivityDetector) Flush() {
	C.EdgevoxOnnxVoiceActivityDetectorFlush(vad.impl)
}
...
type SpokenLanguageIdentification struct {
	impl *C.struct_EdgevoxOnnxSpokenLanguageIdentification
}
...
func NewSpokenLanguageIdentification(config *SpokenLanguageIdentificationConfig) *SpokenLanguageIdentification {
	c := C.struct_EdgevoxOnnxSpokenLanguageIdentificationConfig{}
	...
	slid.impl = C.EdgevoxOnnxCreateSpokenLanguageIdentification(&c)

	return slid
}

func DeleteSpokenLanguageIdentification(slid *SpokenLanguageIdentification) {
	C.EdgevoxOnnxDestroySpokenLanguageIdentification(slid.impl)
	slid.impl = nil
}
...
func (slid *SpokenLanguageIdentification) CreateStream() *OfflineStream {
	stream := &OfflineStream{}
	stream.impl = C.EdgevoxOnnxSpokenLanguageIdentificationCreateOfflineStream(slid.impl)
	return stream
}

func (slid *SpokenLanguageIdentification) Compute(stream *OfflineStream) *SpokenLanguageIdentificationResult {
	r := C.EdgevoxOnnxSpokenLanguageIdentificationCompute(slid.impl, stream.impl)
	// defer C.EdgevoxOnnxDestroySpokenLanguageIdentificationResult(r)
...
type SpeakerEmbeddingExtractor struct {
	impl *C.struct_EdgevoxOnnxSpeakerEmbeddingExtractor
}
...
func NewSpeakerEmbeddingExtractor(config *SpeakerEmbeddingExtractorConfig) *SpeakerEmbeddingExtractor {
	c := C.struct_EdgevoxOnnxSpeakerEmbeddingExtractorConfig{}
	...
	impl := C.EdgevoxOnnxCreateSpeakerEmbeddingExtractor(&c)
	if impl == nil {
		return nil
	}
...
func DeleteSpeakerEmbeddingExtractor(ex *SpeakerEmbeddingExtractor) {
	C.EdgevoxOnnxDestroySpeakerEmbeddingExtractor(ex.impl)
	ex.impl = nil
}

func (ex *SpeakerEmbeddingExtractor) Dim() int {
	return int(C.EdgevoxOnnxSpeakerEmbeddingExtractorDim(ex.impl))
}
...
func (ex *SpeakerEmbeddingExtractor) CreateStream() *OnlineStream {
	stream := &OnlineStream{}
	stream.impl = C.EdgevoxOnnxSpeakerEmbeddingExtractorCreateStream(ex.impl)
	return stream
}

func (ex *SpeakerEmbeddingExtractor) IsReady(stream *OnlineStream) bool {
	return int(C.EdgevoxOnnxSpeakerEmbeddingExtractorIsReady(ex.impl, stream.impl)) == 1
}

func (ex *SpeakerEmbeddingExtractor) Compute(stream *OnlineStream) []float32 {
	embedding := C.EdgevoxOnnxSpeakerEmbeddingExtractorComputeEmbedding(ex.impl, stream.impl)
	defer C.EdgevoxOnnxSpeakerEmbeddingExtractorDestroyEmbedding(embedding)
...
type SpeakerEmbeddingManager struct {
	impl *C.struct_EdgevoxOnnxSpeakerEmbeddingManager
}
...
func NewSpeakerEmbeddingManager(dim int) *SpeakerEmbeddingManager {
	impl := C.EdgevoxOnnxCreateSpeakerEmbeddingManager(C.int(dim))
	if impl == nil {
		return nil
	}
...
func DeleteSpeakerEmbeddingManager(m *SpeakerEmbeddingManager) {
	C.EdgevoxOnnxDestroySpeakerEmbeddingManager(m.impl)
	m.impl = nil
}
...
func (m *SpeakerEmbeddingManager) Register(name string, embedding []float32) bool {
	...
	return C.int(C.EdgevoxOnnxSpeakerEmbeddingManagerAdd(m.impl, s, (*C.float)(&embedding[0]))) == 1
}
...
func (m *SpeakerEmbeddingManager) RegisterV(name string, embeddings [][]float32) bool {
	...
	return C.int(C.EdgevoxOnnxSpeakerEmbeddingManagerAddListFlattened(m.impl, s, (*C.float)(&v[0]), C.int(len(embeddings)))) == 1
}
...
func (m *SpeakerEmbeddingManager) Remove(name string) bool {
	...
	return C.int(C.EdgevoxOnnxSpeakerEmbeddingManagerRemove(m.impl, s)) == 1
}

func (m *SpeakerEmbeddingManager) Search(embedding []float32, threshold float32) string {
	var s string

	name := C.EdgevoxOnnxSpeakerEmbeddingManagerSearch(m.impl, (*C.float)(&embedding[0]), C.float(threshold))
	defer C.EdgevoxOnnxSpeakerEmbeddingManagerFreeSearch(name)
...
func (m *SpeakerEmbeddingManager) Verify(name string, embedding []float32, threshold float32) bool {
	...
	return C.int(C.EdgevoxOnnxSpeakerEmbeddingManagerVerify(m.impl, s, (*C.float)(&embedding[0]), C.float(threshold))) == 1
}
...
func (m *SpeakerEmbeddingManager) Contains(name string) bool {
	...
	return C.int(C.EdgevoxOnnxSpeakerEmbeddingManagerContains(m.impl, s)) == 1
}

func (m *SpeakerEmbeddingManager) NumSpeakers() int {
	return int(C.EdgevoxOnnxSpeakerEmbeddingManagerNumSpeakers(m.impl))
}

func (m *SpeakerEmbeddingManager) AllSpeakers() []string {
	all_speakers := C.EdgevoxOnnxSpeakerEmbeddingManagerGetAllSpeakers(m.impl)
	defer C.EdgevoxOnnxSpeakerEmbeddingManagerFreeAllSpeakers(all_speakers)
...
func ReadWave(filename string) *Wave {
	...
	w := C.EdgevoxOnnxReadWave(s)
	defer C.EdgevoxOnnxFreeWave(w)
...
func NewOfflineSpeakerDiarization(config *OfflineSpeakerDiarizationConfig) *OfflineSpeakerDiarization {
	...
	p := C.EdgevoxOnnxCreateOfflineSpeakerDiarization(&c)
...
func (sd *OfflineSpeakerDiarization) SampleRate() int {
	return int(C.EdgevoxOnnxOfflineSpeakerDiarizationGetSampleRate(sd.impl))
}
...
func (sd *OfflineSpeakerDiarization) SetConfig(config *OfflineSpeakerDiarizationConfig) {
	...
	C.EdgevoxOnnxOfflineSpeakerDiarizationSetConfig(sd.impl, &c)
}
...
func (sd *OfflineSpeakerDiarization) Process(samples []float32) []OfflineSpeakerDiarizationSegment {
	r := C.EdgevoxOnnxOfflineSpeakerDiarizationProcess(sd.impl, (*C.float)(&samples[0]), C.int(len(samples)))
	defer C.EdgevoxOnnxOfflineSpeakerDiarizationDestroyResult(r)

	n := int(C.EdgevoxOnnxOfflineSpeakerDiarizationResultGetNumSegments(r))

	if n == 0 {
		return nil
	}

	s := C.EdgevoxOnnxOfflineSpeakerDiarizationResultSortByStartTime(r)
	defer C.EdgevoxOnnxOfflineSpeakerDiarizationDestroySegment(s)
...
type OfflinePunctuation struct {
	impl *C.struct_EdgevoxOnnxOfflinePunctuation
}

func NewOfflinePunctuation(config *OfflinePunctuationConfig) *OfflinePunctuation {
	cfg := C.struct_EdgevoxOnnxOfflinePunctuationConfig{}
	...
	impl := C.EdgevoxOnnxCreateOfflinePunctuation(&cfg)
	if impl == nil {
		return nil
	}
...
func DeleteOfflinePunc(punc *OfflinePunctuation) {
	C.EdgevoxOnnxDestroyOfflinePunctuation(punc.impl)
	punc.impl = nil
}
...
type OnlinePunctuation struct {
	impl *C.struct_EdgevoxOnnxOnlinePunctuation
}

func NewOnlinePunctuation(config *OnlinePunctuationConfig) *OnlinePunctuation {
	cfg := C.struct_EdgevoxOnnxOnlinePunctuationConfig{}
	...
	impl := C.EdgevoxOnnxCreateOnlinePunctuation(&cfg)
	if impl == nil {
		return nil
	}
...
func DeleteOnlinePunctuation(punc *OnlinePunctuation) {
	C.EdgevoxOnnxDestroyOnlinePunctuation(punc.impl)
	punc.impl = nil
}
...
func (punc *OnlinePunctuation) AddPunct(text string) string {
	...
	p := C.EdgevoxOnnxOnlinePunctuationAddPunct(punc.impl, inputText)
	if p == nil {
		return ""
	}
	defer C.EdgevoxOnnxOnlinePunctuationFreeText(p)
...
type KeywordSpotter struct {
	impl *C.struct_EdgevoxOnnxKeywordSpotter
}

// Free the internal pointer inside the recognizer to avoid memory leak.
func DeleteKeywordSpotter(spotter *KeywordSpotter) {
	C.EdgevoxOnnxDestroyKeywordSpotter(spotter.impl)
	spotter.impl = nil
}
...
func NewKeywordSpotter(config *KeywordSpotterConfig) *KeywordSpotter {
	c := C.struct_EdgevoxOnnxKeywordSpotterConfig{}
	c.feat_config.sample_rate = C.int(config.FeatConfig.SampleRate)
	c.feat_config.feature_dim = C.int(config.FeatConfig.FeatureDim)
	...
	impl := C.EdgevoxOnnxCreateKeywordSpotter(&c)
	if impl == nil {
		return nil
	}
...
func NewKeywordStream(spotter *KeywordSpotter) *OnlineStream {
	stream := &OnlineStream{}
	stream.impl = C.EdgevoxOnnxCreateKeywordStream(spotter.impl)
	return stream
}
...
func NewKeywordStreamWithKeywords(spotter *KeywordSpotter, keywords string) *OnlineStream {
	...
	stream.impl = C.EdgevoxOnnxCreateKeywordStreamWithKeywords(spotter.impl, s)
	return stream
}
...
func (spotter *KeywordSpotter) IsReady(s *OnlineStream) bool {
	return C.EdgevoxOnnxIsKeywordStreamReady(spotter.impl, s.impl) == 1
}
...
func (spotter *KeywordSpotter) Decode(s *OnlineStream) {
	C.EdgevoxOnnxDecodeKeywordStream(spotter.impl, s.impl)
}

// You MUST call it right after detecting a keyword
func (spotter *KeywordSpotter) Reset(s *OnlineStream) {
	C.EdgevoxOnnxResetKeywordStream(spotter.impl, s.impl)
}

// Get the current result of stream since the last invoke of Reset()
func (spotter *KeywordSpotter) GetResult(s *OnlineStream) *KeywordSpotterResult {
	p := C.EdgevoxOnnxGetKeywordResult(spotter.impl, s.impl)
	defer C.EdgevoxOnnxDestroyKeywordResult(p)
...
type AudioTagging struct {
	impl *C.struct_EdgevoxOnnxAudioTagging
}
...
func DeleteAudioTagging(tagging *AudioTagging) {
	C.EdgevoxOnnxDestroyAudioTagging(tagging.impl)
	tagging.impl = nil
}
...
func NewAudioTagging(config *AudioTaggingConfig) *AudioTagging {
	c := C.struct_EdgevoxOnnxAudioTaggingConfig{}
	...
	impl := C.EdgevoxOnnxCreateAudioTagging(&c)
	if impl == nil {
		return nil
	}
...
func NewAudioTaggingStream(tagging *AudioTagging) *OfflineStream {
	stream := &OfflineStream{}
	stream.impl = C.EdgevoxOnnxAudioTaggingCreateOfflineStream(tagging.impl)
	return stream
}

func (tagging *AudioTagging) Compute(s *OfflineStream, topK int32) []AudioEvent {
	r := C.EdgevoxOnnxAudioTaggingCompute(tagging.impl, s.impl, C.int(topK))
	defer C.EdgevoxOnnxAudioTaggingFreeResults(r)
	result := make([]AudioEvent, 0)

	p := (*[1 << 25]*C.struct_EdgevoxOnnxAudioEvent)(unsafe.Pointer(r))
	i := 0
	for {
		if p[i] == nil {
			break
...
type OfflineSpeechDenoiser struct {
	impl *C.struct_EdgevoxOnnxOfflineSpeechDenoiser
}
...
type OnlineSpeechDenoiser struct {
	impl *C.struct_EdgevoxOnnxOnlineSpeechDenoiser
}
...
func denoisedAudioFromPointer(audio *C.struct_EdgevoxOnnxDenoisedAudio) *DenoisedAudio {
	if audio == nil {
		return &DenoisedAudio{}
	}

	defer C.EdgevoxOnnxDestroyDenoisedAudio(audio)
...
func DeleteOfflineSpeechDenoiser(sd *OfflineSpeechDenoiser) {
	C.EdgevoxOnnxDestroyOfflineSpeechDenoiser(sd.impl)
	sd.impl = nil
}
...
func NewOfflineSpeechDenoiser(config *OfflineSpeechDenoiserConfig) *OfflineSpeechDenoiser {
	c := C.struct_EdgevoxOnnxOfflineSpeechDenoiserConfig{}
	...
	impl := C.EdgevoxOnnxCreateOfflineSpeechDenoiser(&c)
	if impl == nil {
		return nil
	}
...
func (sd *OfflineSpeechDenoiser) Run(samples []float32, sampleRate int) *DenoisedAudio {
	audio := C.EdgevoxOnnxOfflineSpeechDenoiserRun(sd.impl, floatPointer(samples), C.int(len(samples)), C.int(sampleRate))
...
func (audio *DenoisedAudio) Save(filename string) bool {
	...
	ok := int(C.EdgevoxOnnxWriteWave(floatPointer(audio.Samples), C.int(len(audio.Samples)), C.int(audio.SampleRate), s))

	return ok == 1
}

func (sd *OfflineSpeechDenoiser) SampleRate() int {
	return int(C.EdgevoxOnnxOfflineSpeechDenoiserGetSampleRate(sd.impl))
}
...
func DeleteOnlineSpeechDenoiser(sd *OnlineSpeechDenoiser) {
	C.EdgevoxOnnxDestroyOnlineSpeechDenoiser(sd.impl)
	sd.impl = nil
}
...
func NewOnlineSpeechDenoiser(config *OnlineSpeechDenoiserConfig) *OnlineSpeechDenoiser {
	c := C.struct_EdgevoxOnnxOnlineSpeechDenoiserConfig{}
	c.model.gtcrn.model = C.CString(config.Model.Gtcrn.Model)
	defer C.free(unsafe.Pointer(c.model.gtcrn.model))
	c.model.dpdfnet.model = C.CString(config.Model.DpdfNet.Model)
	defer C.free(unsafe.Pointer(c.model.dpdfnet.model))
	...
	impl := C.EdgevoxOnnxCreateOnlineSpeechDenoiser(&c)
	if impl == nil {
		return nil
	}
...
func (sd *OnlineSpeechDenoiser) Run(samples []float32, sampleRate int) *DenoisedAudio {
	audio := C.EdgevoxOnnxOnlineSpeechDenoiserRun(sd.impl, floatPointer(samples), C.int(len(samples)), C.int(sampleRate))
	return denoisedAudioFromPointer(audio)
}

func (sd *OnlineSpeechDenoiser) Flush() *DenoisedAudio {
	audio := C.EdgevoxOnnxOnlineSpeechDenoiserFlush(sd.impl)
	return denoisedAudioFromPointer(audio)
}

func (sd *OnlineSpeechDenoiser) Reset() {
	C.EdgevoxOnnxOnlineSpeechDenoiserReset(sd.impl)
}

func (sd *OnlineSpeechDenoiser) SampleRate() int {
	return int(C.EdgevoxOnnxOnlineSpeechDenoiserGetSampleRate(sd.impl))
}

func (sd *OnlineSpeechDenoiser) FrameShiftInSamples() int {
	return int(C.EdgevoxOnnxOnlineSpeechDenoiserGetFrameShiftInSamples(sd.impl))
}

func GetVersion() string {
	return C.GoString(C.EdgevoxOnnxGetVersionStr())
}

func GetGitSha1() string {
	return C.GoString(C.EdgevoxOnnxGetGitSha1())
}

func GetGitDate() string {
	return C.GoString(C.EdgevoxOnnxGetGitDate())
}
...
// UvrConfig wraps EdgevoxOnnxOfflineSourceSeparationUvrModelConfig
...
type AudioBuffer struct {
	...
	cWave             *C.EdgevoxOnnxMultiChannelWave // Pointer if C-managed
}
...
func ReadWaveMultiChannel(filename string) *AudioBuffer {
	...
	ptr := C.EdgevoxOnnxReadWaveMultiChannel(cStr)
	if ptr == nil {
		return nil
	}
...
func (b *AudioBuffer) Release() {
	if b.cWave != nil {
		C.EdgevoxOnnxFreeMultiChannelWave(b.cWave)
		b.cWave = nil
		b.Samples = nil
	}
}
...
func (b *AudioBuffer) Save(filename string) bool {
	...
	res := C.EdgevoxOnnxWriteWaveMultiChannel(
...
type SourceSeparator struct {
	handle *C.EdgevoxOnnxOfflineSourceSeparation
}
...
func NewSourceSeparator(cfg OfflineSourceSeparationConfig) *SourceSeparator {
	var cCfg C.EdgevoxOnnxOfflineSourceSeparationConfig
	...
	h := C.EdgevoxOnnxCreateOfflineSourceSeparation(&cCfg)
	if h == nil {
		return nil
	}
...
func (ss *SourceSeparator) Delete() {
	if ss.handle != nil {
		C.EdgevoxOnnxDestroyOfflineSourceSeparation(ss.handle)
		ss.handle = nil
	}
}
...
func (ss *SourceSeparator) Process(buf *AudioBuffer) []*AudioBuffer {
	...
	cOut := C.EdgevoxOnnxOfflineSourceSeparationProcess(
		ss.handle,
		(**C.float)(unsafe.Pointer(cPtrs)),
	...
	defer C.EdgevoxOnnxDestroySourceSeparationOutput(cOut)
	...
	for i := 0; i < numStems; i++ {
		cStem := (*[1 << 20]C.EdgevoxOnnxSourceSeparationStem)(unsafe.Pointer(cOut.stems))[i]
