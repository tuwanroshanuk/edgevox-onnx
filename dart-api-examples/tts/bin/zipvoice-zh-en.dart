...
void main(List<String> arguments) async {
  ...
  final zipvoice = edgevox_onnx.OfflineTtsZipVoiceModelConfig(
    tokens: tokens,
    encoder: encoder,
    decoder: decoder,
    vocoder: vocoder,
  ...
  final config = edgevox_onnx.OfflineTtsConfig(model: modelConfig);

  final tts = edgevox_onnx.OfflineTts(config);

  final wave = edgevox_onnx.readWave(referenceAudioPath);
