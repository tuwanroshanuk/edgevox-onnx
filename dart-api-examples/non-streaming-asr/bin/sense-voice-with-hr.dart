...
void main(List<String> arguments) async {
  ...
  print('edgevox-onnx version: ${edgevox_onnx.getVersion()}');
  print('edgevox-onnx gitSha1: ${edgevox_onnx.getGitSha1()}');
  print('edgevox-onnx gitDate: ${edgevox_onnx.getGitDate()}');
  ...
  final senseVoice = edgevox_onnx.OfflineSenseVoiceModelConfig(
  ...
  final hr = edgevox_onnx.HomophoneReplacerConfig(
      lexicon: hrLexicon, ruleFsts: hrRuleFsts);

  final config =
      edgevox_onnx.OfflineRecognizerConfig(model: modelConfig, hr: hr);
