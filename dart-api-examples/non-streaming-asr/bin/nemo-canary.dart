...
void main(List<String> arguments) async {
  ...
  final canary = edgevox_onnx.OfflineCanaryModelConfig(
  ...
  var config = edgevox_onnx.OfflineRecognizerConfig(model: modelConfig);
  ...
  if (tgtLang != 'en') {
    ...
    config = edgevox_onnx.OfflineRecognizerConfig.fromJson(json);
