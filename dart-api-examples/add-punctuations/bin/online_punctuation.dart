...
void main(List<String> arguments) async {
  ...
  final modelConfig = edgevox_onnx.OnlinePunctuationModelConfig(
    cnnBiLstm: modelFile,
    bpeVocab: bpeVocab,
    numThreads: 1,
    provider: 'cpu',
  ...
  final config = edgevox_onnx.OnlinePunctuationConfig(model: modelConfig);
  final punct = edgevox_onnx.OnlinePunctuation(config: config);
