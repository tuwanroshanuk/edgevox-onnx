...
void main(List<String> arguments) async {
  ...
  final modelConfig = edgevox_onnx.OfflinePunctuationModelConfig(
  ...
  final config = edgevox_onnx.OfflinePunctuationConfig(model: modelConfig);

  final punct = edgevox_onnx.OfflinePunctuation(config: config);
