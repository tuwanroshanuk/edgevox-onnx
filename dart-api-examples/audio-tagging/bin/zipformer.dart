...
void main(List<String> arguments) async {
  ...
  final zipformerModelConfig =
      edgevox_onnx.OfflineZipformerAudioTaggingModelConfig(
    model: model,
  );

  final modelConfig = edgevox_onnx.AudioTaggingModelConfig(
  ...
  final config = edgevox_onnx.AudioTaggingConfig(
    model: modelConfig,
    labels: labels,
  );

  final at = edgevox_onnx.AudioTagging(config: config);
