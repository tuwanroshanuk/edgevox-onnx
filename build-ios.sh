...
for f in libkaldi-native-fbank-core.a libkissfft-float.a libedgevox-onnx-c-api.a libedgevox-onnx-core.a \
         libedgevox-onnx-fstfar.a libssentencepiece_core.a \
         libedgevox-onnx-fst.a libedgevox-onnx-kaldifst-core.a libkaldi-decoder-core.a \
...
libtool -static -o build/simulator/libedgevox-onnx.a \
...
libtool -static -o build/os64/libedgevox-onnx.a \
...
xcodebuild -create-xcframework \
      -library "build/os64/libedgevox-onnx.a" -headers install/include \
      -library "build/simulator/libedgevox-onnx.a" -headers install/include  \
