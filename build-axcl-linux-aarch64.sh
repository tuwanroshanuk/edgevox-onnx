...
# and set the environment variable EDGEVOX_ONNX_AXCL_SDK_ROOT

if [ -d ./axcl_bsp_sdk ]; then
  AXCL_SDK_ROOT=/star-fj/fangjun/open-source/edgevox-onnx/axcl_bsp_sdk/out
fi

if [ -z "$AXCL_SDK_ROOT" ]; then
  AXCL_SDK_ROOT=/home/m5stack/Workspace/kaldi/edgevox-onnx/axcl_bsp_sdk/out
...
export EDGEVOX_ONNX_AXCL_LIB_DIR="$AXCL_SDK_ROOT/lib"
