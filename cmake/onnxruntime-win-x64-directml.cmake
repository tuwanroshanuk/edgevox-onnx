...
if(NOT EDGEVOX_ONNX_ENABLE_DIRECTML)
  message(FATAL_ERROR "This file is for DirectML. Given EDGEVOX_ONNX_ENABLE_DIRECTML: ${EDGEVOX_ONNX_ENABLE_DIRECTML}")
endif()
...
if(location_onnxruntime_header_dir AND location_onnxruntime_lib)
    ...
    set(onnxruntime_URL2 "https://hf-mirror.com/csukuangfj/edgevox-onnx-cmake-deps/resolve/main/microsoft.ml.onnxruntime.directml.1.14.1.nupkg")
