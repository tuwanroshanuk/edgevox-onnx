...
if(Git_FOUND)
  execute_process(COMMAND
    ...
    OUTPUT_VARIABLE EDGEVOX_ONNX_GIT_SHA1
  ...
  execute_process(COMMAND
    ...
    WORKING_DIRECTORY "${CMAKE_SOURCE_DIR}"
    OUTPUT_VARIABLE EDGEVOX_ONNX_GIT_DATE
    ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE
  )
  message(STATUS "edgevox-onnx git sha1: ${EDGEVOX_ONNX_GIT_SHA1}")
  message(STATUS "edgevox-onnx git date: ${EDGEVOX_ONNX_GIT_DATE}")
else()
...
if(UNIX AND NOT APPLE)
  execute_process(COMMAND
    lsb_release -sd
    OUTPUT_VARIABLE EDGEVOX_ONNX_OS
...
elseif(APPLE)
  ...
  set(EDGEVOX_ONNX_OS "${_product_name} ${_product_version} ${_build_version}")
elseif(WIN32)
  ...
  if(NOT EDGEVOX_ONNX_OS)
    ...
    if(_cmd_out)
      set(EDGEVOX_ONNX_OS "Windows ${_cmd_out}")
    else()
      set(EDGEVOX_ONNX_OS "Windows (version unknown)")
    endif()
  endif()
else()
  set(EDGEVOX_ONNX_OS "Unknown")
endif()
message(STATUS "OS used to build edgevox-onnx: ${EDGEVOX_ONNX_OS}")
