...
message(WARNING "\
EDGEVOX_ONNX_LINUX_ARM64_GPU_ONNXRUNTIME_VERSION: ${EDGEVOX_ONNX_LINUX_ARM64_GPU_ONNXRUNTIME_VERSION}
If you use Jetson nano b01, then please pass
   -DEDGEVOX_ONNX_LINUX_ARM64_GPU_ONNXRUNTIME_VERSION=1.11.0
to cmake (You need to make sure CUDA 10.2 is available on your board).

If you use Jetson Orin NX, then please pass
   -DEDGEVOX_ONNX_LINUX_ARM64_GPU_ONNXRUNTIME_VERSION=1.16.0
...
Super - Jetpack 6.2 [L4T 36.4.3], then please pass
   -DEDGEVOX_ONNX_LINUX_ARM64_GPU_ONNXRUNTIME_VERSION=1.18.1
to cmake (You need to make sure CUDA 12.6 is available on your board).
")

set(v ${EDGEVOX_ONNX_LINUX_ARM64_GPU_ONNXRUNTIME_VERSION})
