function(download_portaudio)
  ...
  set(portaudio_URL2 "https://hf-mirror.com/csukuangfj/edgevox-onnx-cmake-deps/resolve/main/pa_stable_v190700_20210406.tgz")
  ...
  set_target_properties(pa_devs PROPERTIES OUTPUT_NAME "edgevox-onnx-pa-devs")

  set_target_properties(portaudio_static PROPERTIES OUTPUT_NAME "edgevox-onnx-portaudio_static")
  if(NOT WIN32)
    target_compile_options(portaudio_static PRIVATE "-Wno-deprecated-declarations")
  endif()

  if(NOT BUILD_SHARED_LIBS AND EDGEVOX_ONNX_ENABLE_BINARY)
    install(TARGETS
      portaudio_static
    DESTINATION lib)
  endif()
