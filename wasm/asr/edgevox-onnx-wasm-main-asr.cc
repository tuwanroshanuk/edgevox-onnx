// wasm/edgevox-onnx-wasm-main-asr.cc
//
...
static_assert(sizeof(EdgevoxOnnxOnlineNemoCtcModelConfig) == 1 * 4, "");
...
static_assert(sizeof(EdgevoxOnnxOnlineCtcFstDecoderConfig) == 2 * 4, "");
static_assert(sizeof(EdgevoxOnnxOnlineRecognizerConfig) ==
                  sizeof(EdgevoxOnnxFeatureConfig) +
                      sizeof(EdgevoxOnnxOnlineModelConfig) + 8 * 4 +
                      sizeof(EdgevoxOnnxOnlineCtcFstDecoderConfig) + 5 * 4 +
                      sizeof(EdgevoxOnnxHomophoneReplacerConfig),
              "");

void MyPrint(EdgevoxOnnxOnlineRecognizerConfig *config) {
