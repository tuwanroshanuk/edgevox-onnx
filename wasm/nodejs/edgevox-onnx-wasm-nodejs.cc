// wasm/edgevox-onnx-wasm-main-nodejs.cc
//
...
static_assert(sizeof(EdgevoxOnnxOfflineTransducerModelConfig) == 3 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineParaformerModelConfig) == 4, "");

static_assert(sizeof(EdgevoxOnnxOfflineZipformerCtcModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineWenetCtcModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineOmnilingualAsrCtcModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineMedAsrCtcModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineFireRedAsrCtcModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineFunASRNanoModelConfig) == 13 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineQwen3ASRModelConfig) == 10 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineCohereTranscribeModelConfig) == 5 * 4,
              "");
static_assert(sizeof(EdgevoxOnnxOfflineDolphinModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineNemoEncDecCtcModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineWhisperModelConfig) == 7 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineFireRedAsrModelConfig) == 2 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineMoonshineModelConfig) == 5 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineTdnnModelConfig) == 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineSenseVoiceModelConfig) == 3 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineCanaryModelConfig) == 5 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineLMConfig) == 2 * 4, "");

static_assert(sizeof(EdgevoxOnnxOfflineModelConfig) ==
                  sizeof(EdgevoxOnnxOfflineTransducerModelConfig) +
                      sizeof(EdgevoxOnnxOfflineParaformerModelConfig) +
                      sizeof(EdgevoxOnnxOfflineNemoEncDecCtcModelConfig) +
                      sizeof(EdgevoxOnnxOfflineWhisperModelConfig) +
                      sizeof(EdgevoxOnnxOfflineTdnnModelConfig) + 8 * 4 +
                      sizeof(EdgevoxOnnxOfflineSenseVoiceModelConfig) +
                      sizeof(EdgevoxOnnxOfflineMoonshineModelConfig) +
                      sizeof(EdgevoxOnnxOfflineFireRedAsrModelConfig) +
                      sizeof(EdgevoxOnnxOfflineDolphinModelConfig) +
                      sizeof(EdgevoxOnnxOfflineZipformerCtcModelConfig) +
                      sizeof(EdgevoxOnnxOfflineCanaryModelConfig) +
                      sizeof(EdgevoxOnnxOfflineWenetCtcModelConfig) +
                      sizeof(EdgevoxOnnxOfflineOmnilingualAsrCtcModelConfig) +
                      sizeof(EdgevoxOnnxOfflineMedAsrCtcModelConfig) +
                      sizeof(EdgevoxOnnxOfflineFunASRNanoModelConfig) +
                      sizeof(EdgevoxOnnxOfflineFireRedAsrCtcModelConfig) +
                      sizeof(EdgevoxOnnxOfflineQwen3ASRModelConfig) +
                      sizeof(EdgevoxOnnxOfflineCohereTranscribeModelConfig),

              "");
static_assert(sizeof(EdgevoxOnnxFeatureConfig) == 2 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineRecognizerConfig) ==
                  sizeof(EdgevoxOnnxFeatureConfig) +
                      sizeof(EdgevoxOnnxOfflineLMConfig) +
                      sizeof(EdgevoxOnnxOfflineModelConfig) + 7 * 4 +
                      sizeof(EdgevoxOnnxHomophoneReplacerConfig),
              "");

void PrintOfflineTtsConfig(EdgevoxOnnxOfflineTtsConfig *tts_config) {
  ...
  fprintf(stdout, "data_dir: %s\n", zipvoice->data_dir);
  fprintf(stdout, "lexicon: %s\n", zipvoice->lexicon);
  fprintf(stdout, "espeak_voice: %s\n", zipvoice->espeak_voice);
...
void PrintOfflineRecognizerConfig(EdgevoxOnnxOfflineRecognizerConfig *config) {
