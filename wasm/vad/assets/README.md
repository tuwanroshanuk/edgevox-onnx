...
https://github.com/k2-fsa/edgevox-onnx/blob/master/.github/workflows/wasm-simd-hf-space-silero-vad.yaml

```
cd /path/to/edgevox-onnx/wasm/vad/assets
...
You can find example build script at
https://github.com/k2-fsa/edgevox-onnx/blob/master/.github/workflows/wasm-simd-hf-space-ten-vad.yaml
