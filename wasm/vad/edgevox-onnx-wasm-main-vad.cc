// wasm/edgevox-onnx-wasm-main-vad.cc
//
...
static_assert(sizeof(EdgevoxOnnxSileroVadModelConfig) == 6 * 4, "");
static_assert(sizeof(EdgevoxOnnxTenVadModelConfig) == 6 * 4, "");

static_assert(sizeof(EdgevoxOnnxVadModelConfig) ==
                  sizeof(EdgevoxOnnxSileroVadModelConfig) + 4 * 4 +
                      sizeof(EdgevoxOnnxTenVadModelConfig),
              "");
void MyPrint(EdgevoxOnnxVadModelConfig *config) {
