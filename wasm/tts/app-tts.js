...
let audioCtx = null;
const worker = new Worker("edgevox-onnx-tts.worker.js", { type: "module" });
let ttsInstanceInfo = {
  modelType: null,
  numSpeakers: 0,
  isReady: false,
...
worker.onmessage = (e) => {
  ...
  if (e.data.type === "edgevox-onnx-tts-result") {
    let audio = e.data;
    generateBtn.disabled = false;
    setGenerationStatus('');
