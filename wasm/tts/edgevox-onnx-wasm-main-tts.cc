// wasm/edgevox-onnx-wasm-main-tts.cc
//
...
static_assert(sizeof(EdgevoxOnnxOfflineTtsZipvoiceModelConfig) == 11 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineTtsPocketModelConfig) == 8 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineTtsSupertonicModelConfig) == 7 * 4, "");
static_assert(sizeof(EdgevoxOnnxOfflineTtsModelConfig) ==
                  sizeof(EdgevoxOnnxOfflineTtsVitsModelConfig) +
                      sizeof(EdgevoxOnnxOfflineTtsMatchaModelConfig) +
                      sizeof(EdgevoxOnnxOfflineTtsKokoroModelConfig) + 3 * 4 +
                      sizeof(EdgevoxOnnxOfflineTtsKittenModelConfig) +
                      sizeof(EdgevoxOnnxOfflineTtsZipvoiceModelConfig) +
                      sizeof(EdgevoxOnnxOfflineTtsPocketModelConfig) +
                      sizeof(EdgevoxOnnxOfflineTtsSupertonicModelConfig),
              "");

static_assert(sizeof(EdgevoxOnnxOfflineTtsConfig) ==
                  sizeof(EdgevoxOnnxOfflineTtsModelConfig) + 4 * 4,
              "");

static_assert(sizeof(EdgevoxOnnxGenerationConfig) == 9 * 4, "");

void MyPrint(EdgevoxOnnxOfflineTtsConfig *tts_config) {
