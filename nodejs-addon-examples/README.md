...
`edgevox-onnx` for NodeJS and it does not support multiple threads.
...
# For macOS x64
## With npm
export DYLD_LIBRARY_PATH=$PWD/node_modules/edgevox-onnx-darwin-x64:$DYLD_LIBRARY_PATH
## With pnpm
export DYLD_LIBRARY_PATH=$PWD/node_modules/.pnpm/edgevox-onnx-node@<REPLACE-THIS-WITH-THE-INSTALLED-VERSION>/node_modules/edgevox-onnx-darwin-x64:$DYLD_LIBRARY_PATH

# For macOS arm64
## With npm
export DYLD_LIBRARY_PATH=$PWD/node_modules/edgevox-onnx-darwin-arm64:$DYLD_LIBRARY_PATH
## With pnpm
export DYLD_LIBRARY_PATH=$PWD/node_modules/.pnpm/edgevox-onnx-node@<REPLACE-THIS-WITH-THE-INSTALLED-VERSION>/node_modules/edgevox-onnx-darwin-arm64:$DYLD_LIBRARY_PATH

# For Linux x64
## With npm
export LD_LIBRARY_PATH=$PWD/node_modules/edgevox-onnx-linux-x64:$LD_LIBRARY_PATH
## With pnpm
export LD_LIBRARY_PATH=$PWD/node_modules/.pnpm/edgevox-onnx-node@<REPLACE-THIS-WITH-THE-INSTALLED-VERSION>/node_modules/edgevox-onnx-linux-x64:$LD_LIBRARY_PATH

# For Linux arm64, e.g., Raspberry Pi 4
## With npm
export LD_LIBRARY_PATH=$PWD/node_modules/edgevox-onnx-linux-arm64:$LD_LIBRARY_PATH
## With pnpm
export LD_LIBRARY_PATH=$PWD/node_modules/.pnpm/edgevox-onnx-node@<REPLACE-THIS-WITH-THE-INSTALLED-VERSION>/node_modules/edgevox-onnx-linux-arm64:$LD_LIBRARY_PATH
```
...
|File| Description|
|---|---|
|[./test_offline_speech_enhancement_gtcrn.js](./test_offline_speech_enhancement_gtcrn.js)| It demonstrates how to use edgevox-onnx JavaScript API for speech enhancement with GTCRN.|
|[./test_offline_speech_enhancement_dpdfnet.js](./test_offline_speech_enhancement_dpdfnet.js)| It demonstrates how to use edgevox-onnx JavaScript API for speech enhancement with DPDFNet.|
|[./test_online_speech_enhancement_gtcrn.js](./test_online_speech_enhancement_gtcrn.js)| It demonstrates how to use edgevox-onnx JavaScript API for online speech enhancement with GTCRN.|
|[./test_online_speech_enhancement_dpdfnet.js](./test_online_speech_enhancement_dpdfnet.js)| It demonstrates how to use edgevox-onnx JavaScript API for online speech enhancement with DPDFNet.|

## Speaker diarization

|File| Description|
|---|---|
|[./test_offline_speaker_diarization.js](./test_offline_speaker_diarization.js)| It demonstrates how to use edgevox-onnx JavaScript API for speaker diarization. It supports speaker segmentation models from [pyannote-audio](https://github.com/pyannote/pyannote-audio)|
