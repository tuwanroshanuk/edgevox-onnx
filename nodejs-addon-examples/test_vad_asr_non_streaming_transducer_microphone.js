...
function createRecognizer() {
  ...
  const config = {
    ...
    'modelConfig': {
      'transducer': {
        'encoder':
            './edgevox-onnx-zipformer-en-2023-04-01/encoder-epoch-99-avg-1.int8.onnx',
        'decoder':
            './edgevox-onnx-zipformer-en-2023-04-01/decoder-epoch-99-avg-1.onnx',
        'joiner':
            './edgevox-onnx-zipformer-en-2023-04-01/joiner-epoch-99-avg-1.int8.onnx',
      },
  ...
  return new edgevox_onnx.OfflineRecognizer(config);
}
...
function createVad() {
  ...
  return new edgevox_onnx.Vad(config, bufferSizeInSeconds);
}
...
const buffer =
    new edgevox_onnx.CircularBuffer(bufferSizeInSeconds * vad.config.sampleRate);
