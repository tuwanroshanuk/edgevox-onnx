...
function createRecognizer() {
  ...
  const config = {
    ...
    'modelConfig': {
      'nemoCtc': {
        'model':
            './edgevox-onnx-nemo-fast-conformer-ctc-be-de-en-es-fr-hr-it-pl-ru-uk-20k/model.onnx',
      },
      'tokens':
          './edgevox-onnx-nemo-fast-conformer-ctc-be-de-en-es-fr-hr-it-pl-ru-uk-20k/tokens.txt',
      'numThreads': 2,
      'provider': 'cpu',
      'debug': 1,
    }
