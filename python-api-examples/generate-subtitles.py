...
"""
This file demonstrates how to use edgevox-onnx Python APIs to generate
subtitles.
...
to install edgevox-onnx and to download non-streaming pre-trained models
used in this file.
"""
import argparse
...
def create_recognizer(args) -> edgevox_onnx.OfflineRecognizer:
    if args.encoder:
        ...
        recognizer = edgevox_onnx.OfflineRecognizer.from_transducer(
        ...
        recognizer = edgevox_onnx.OfflineRecognizer.from_paraformer(
        ...
        recognizer = edgevox_onnx.OfflineRecognizer.from_wenet_ctc(
        ...
        recognizer = edgevox_onnx.OfflineRecognizer.from_moonshine(
        ...
        recognizer = edgevox_onnx.OfflineRecognizer.from_fire_red_asr(
        ...
        recognizer = edgevox_onnx.OfflineRecognizer.from_fire_red_asr_ctc(
        ...
        recognizer = edgevox_onnx.OfflineRecognizer.from_funasr_nano(
...
def main():
    ...
    config = edgevox_onnx.VadModelConfig()
    if args.silero_vad_model:
    ...
    buffer = []
    vad = edgevox_onnx.VoiceActivityDetector(config, buffer_size_in_seconds=100)
