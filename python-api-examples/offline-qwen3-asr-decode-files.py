...
#
"""
Decode audio files using Qwen3-ASR with edgevox-onnx Python API.
...
try:
    ...
    print("Please install edgevox-onnx: pip install edgevox-onnx")
    sys.exit(1)
...
def create_recognizer(args) -> edgevox_onnx.OfflineRecognizer:
    return edgevox_onnx.OfflineRecognizer.from_qwen3_asr(
...
def decode_file(
    recognizer: edgevox_onnx.OfflineRecognizer, filename: str, language: str = ""
):
