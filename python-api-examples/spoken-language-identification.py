...
def main():
    ...
    config = edgevox_onnx.SpokenLanguageIdentificationConfig(
        whisper=edgevox_onnx.SpokenLanguageIdentificationWhisperConfig(
    ...
    slid = edgevox_onnx.SpokenLanguageIdentification(config)
