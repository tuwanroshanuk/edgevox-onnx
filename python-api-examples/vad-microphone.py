...
def main():
    ...
    if "EDGEVOX_ONNX_MIC_SAMPLE_RATE" in os.environ:
        mic_sample_rate = int(os.environ.get("EDGEVOX_ONNX_MIC_SAMPLE_RATE"))
    ...
    vad = edgevox_onnx.VoiceActivityDetector(config, buffer_size_in_seconds=30)
    ...
    if "EDGEVOX_ONNX_MIC_DEVICE" in os.environ:
        input_device_idx = int(os.environ.get("EDGEVOX_ONNX_MIC_DEVICE"))
        ...
        with sd.InputStream(
            ...
            while True:
                ...
                while not vad.empty():
                    ...
                    k += 1
                    edgevox_onnx.write_wave(filename, samples, sample_rate)
