...
# Two-pass real-time speech recognition from a microphone with edgevox-onnx
# Python API.
#
...
def create_second_pass_recognizer(args) -> edgevox_onnx.OfflineRecognizer:
    if args.second_encoder:
        ...
        while True:
            ...
            if is_endpoint:
                if result:
                    ...
                    # that should work for most streaming models in edgevox-onnx
