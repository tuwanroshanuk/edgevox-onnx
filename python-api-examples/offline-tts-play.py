...
"""
This file demonstrates how to use edgevox-onnx Python API to generate audio
...
wget https://github.com/k2-fsa/edgevox-onnx/releases/download/tts-models/vits-zh-aishell3.tar.bz2
...
def main():
    ...
    tts = edgevox_onnx.OfflineTts(tts_config)
