...
def create_first_pass_recognizer(args) -> edgevox_onnx.OnlineRecognizer:
...
class StreamingServer(object):
    def __init__(
        self,
        first_pass_recognizer: edgevox_onnx.OnlineRecognizer,
        second_pass_recognizer: edgevox_onnx.OfflineRecognizer,
        nn_pool_size: int,
        max_wait_ms: float,
        max_batch_size: int,
