...
"""
This file demonstrates how to use edgevox-onnx Python API to transcribe
...
./python-api-examples/online-decode-files.py \
  ...
  --wenet-ctc=./edgevox-onnx-zh-wenet-wenetspeech/model-streaming.onnx \
  ./edgevox-onnx-zh-wenet-wenetspeech/test_wavs/0.wav \
  ./edgevox-onnx-zh-wenet-wenetspeech/test_wavs/1.wav \
  ./edgevox-onnx-zh-wenet-wenetspeech/test_wavs/8k.wav
...
def main():
    ...
    if args.encoder:
        ...
        recognizer = edgevox_onnx.OnlineRecognizer.from_transducer(
            tokens=args.tokens,
        ...
        recognizer = edgevox_onnx.OnlineRecognizer.from_zipformer2_ctc(
            tokens=args.tokens,
        ...
        recognizer = edgevox_onnx.OnlineRecognizer.from_paraformer(
            tokens=args.tokens,
        ...
        recognizer = edgevox_onnx.OnlineRecognizer.from_wenet_ctc(
            tokens=args.tokens,
