...
def create_offline_source_separation():
    ...
    config = edgevox_onnx.OfflineSourceSeparationConfig(
        model=edgevox_onnx.OfflineSourceSeparationModelConfig(
            spleeter=edgevox_onnx.OfflineSourceSeparationSpleeterModelConfig(
                vocals=vocals,
    ...
    return edgevox_onnx.OfflineSourceSeparation(config)
