...
// This file shows how to use edgevox-onnx CXX API
...
wget https://github.com/k2-fsa/edgevox-onnx/releases/download/tts-models/vits-piper-en_US-lessac-medium.tar.bz2
