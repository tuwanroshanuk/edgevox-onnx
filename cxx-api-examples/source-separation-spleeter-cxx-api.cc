// cxx-api-examples/source-separation-spleeter-cxx-api.cc
//
// Copyright (c)  2026  Xiaomi Corporation
//
// This file demonstrates how to use the source-separation C++ API
// with the Spleeter model.
//
// Usage:
//
...
// 2. Build
//
//  g++ -std=c++17 -o source-separation-spleeter-cxx-api \
//    ./cxx-api-examples/source-separation-spleeter-cxx-api.cc \
//    -I ./build/install/include \
//    -L ./build/install/lib/ \
//    -l edgevox-onnx-cxx-api -l edgevox-onnx-c-api -l onnxruntime
//
// 3. Run
//
//  ./source-separation-spleeter-cxx-api
...
int32_t main() {
  ...
  const auto *wave = EdgevoxOnnxReadWaveMultiChannel("./qi-feng-le-zh.wav");
  if (!wave) {
  ...
  std::vector<std::string> stem_names = {"spleeter-vocals",
  ...
  for (int32_t s = 0;
    ...
    EdgevoxOnnxWriteWaveMultiChannel(stem_ptrs.data(), ns, output.sample_rate,
                                    nc, filename.c_str());
