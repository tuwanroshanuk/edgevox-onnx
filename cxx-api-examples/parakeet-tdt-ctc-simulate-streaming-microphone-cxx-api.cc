...
//
// This file demonstrates how to use parakeet-tdt with edgevox-onnx's C++ API
...
//
// wget https://github.com/k2-fsa/edgevox-onnx/releases/download/asr-models/edgevox-onnx-nemo-parakeet-tdt_ctc-0.6b-ja-35000-int8.tar.bz2
...
static edgevox_onnx::cxx::VoiceActivityDetector CreateVad() {
...
static edgevox_onnx::cxx::OfflineRecognizer CreateOfflineRecognizer() {
  using namespace edgevox_onnx::cxx;  // NOLINT
  OfflineRecognizerConfig config;

  config.model_config.nemo_ctc.model =
      "./edgevox-onnx-nemo-parakeet-tdt_ctc-0.6b-ja-35000-int8/model.int8.onnx";
  config.model_config.tokens =
      "./edgevox-onnx-nemo-parakeet-tdt_ctc-0.6b-ja-35000-int8/tokens.txt";
...
int32_t main() {
  ...
  const char *sample_rate_str = std::getenv("EDGEVOX_ONNX_MIC_SAMPLE_RATE");
  if (sample_rate_str) {
