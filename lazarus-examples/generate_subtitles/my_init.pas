...
function CreateVad(VadFilename: AnsiString): TEdgevoxOnnxVoiceActivityDetector;
var
...
function CreateOfflineRecognizerTransducer(
  ...
  Decoder: AnsiString;
  Joiner: AnsiString;
  ModelType: AnsiString): TEdgevoxOnnxOfflineRecognizer;
var
...
function CreateOfflineRecognizerTeleSpeech(
  Tokens: AnsiString;
  TeleSpeech: AnsiString): TEdgevoxOnnxOfflineRecognizer;
var
  Config: TEdgevoxOnnxOfflineRecognizerConfig;
begin
  Initialize(Config);
...
function CreateOfflineRecognizerParaformer(
  Tokens: AnsiString;
  Paraformer: AnsiString): TEdgevoxOnnxOfflineRecognizer;
var
  Config: TEdgevoxOnnxOfflineRecognizerConfig;
begin
  Initialize(Config);
...
function CreateOfflineRecognizerSenseVoice(
  Tokens: AnsiString;
  SenseVoice: AnsiString): TEdgevoxOnnxOfflineRecognizer;
var
  Config: TEdgevoxOnnxOfflineRecognizerConfig;
begin
  Initialize(Config);
...
function CreateOfflineRecognizerWhisper(
  ...
  WhisperDecoder: AnsiString): TEdgevoxOnnxOfflineRecognizer;
var
  Config: TEdgevoxOnnxOfflineRecognizerConfig;
begin
  Initialize(Config);
...
function CreateOfflineRecognizerMoonshine(
  ...
  CachedDecoder: AnsiString): TEdgevoxOnnxOfflineRecognizer;
var
  Config: TEdgevoxOnnxOfflineRecognizerConfig;
begin
  Initialize(Config);
