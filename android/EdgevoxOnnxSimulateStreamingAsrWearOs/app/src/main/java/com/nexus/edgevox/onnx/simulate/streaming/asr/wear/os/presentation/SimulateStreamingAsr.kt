package com.nexus.edgevox.onnx.simulate.streaming.asr.wear.os.presentation

import android.app.Application
import android.content.res.AssetManager
import android.util.Log
import com.nexus.edgevox.onnx.HomophoneReplacerConfig
import com.nexus.edgevox.onnx.OfflineRecognizer
import com.nexus.edgevox.onnx.OfflineRecognizerConfig
import com.nexus.edgevox.onnx.Vad
import com.nexus.edgevox.onnx.getOfflineModelConfig
import com.nexus.edgevox.onnx.getVadModelConfig
import java.io.File
...
object SimulateStreamingAsr {
    ...
    fun initOfflineRecognizer(assetManager: AssetManager? = null, application: Application) {
        synchronized(this) {
            ...
            Log.i(TAG, "Initializing edgevox-onnx offline recognizer")
            ...
            Log.i(TAG, "edgevox-onnx offline recognizer initialized")
        }
    }
    ...
    fun initVad(assetManager: AssetManager? = null) {
        ...
        Log.i(TAG, "edgevox-onnx vad initialized")
    }
}
