package com.nexus.edgevox.onnx.audio.tagging.wear.os.presentation
...
import com.nexus.edgevox.onnx.AudioEvent
import com.nexus.edgevox.onnx.audio.tagging.Tagger
import com.nexus.edgevox.onnx.audio.tagging.wear.os.presentation.theme.EdgevoxOnnxAudioTaggingWearOsTheme
...
fun HomeScreen() {
    ...
    EdgevoxOnnxAudioTaggingWearOsTheme {
        Box(
            modifier = Modifier
                .fillMaxSize()
