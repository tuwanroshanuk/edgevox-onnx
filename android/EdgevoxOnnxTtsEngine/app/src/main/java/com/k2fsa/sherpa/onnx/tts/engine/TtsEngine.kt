...
object TtsEngine {
    ...
    init {
        ...
        // Please see
        // https://github.com/k2-fsa/edgevox-onnx/blob/master/scripts/apk/generate-tts-apk-script.py
        //
        // For VITS -- begin
        modelName = null
        // For VITS -- end
        ...
        // Example 1:
        // https://github.com/k2-fsa/edgevox-onnx/releases/download/tts-models/vits-vctk.tar.bz2
        // modelDir = "vits-vctk"
        ...
        // https://github.com/k2-fsa/edgevox-onnx/releases/tag/tts-models
        // modelDir = "edgevox-onnx-supertonic-3-tts-int8-2026-05-11"
        // isSupertonic = true
