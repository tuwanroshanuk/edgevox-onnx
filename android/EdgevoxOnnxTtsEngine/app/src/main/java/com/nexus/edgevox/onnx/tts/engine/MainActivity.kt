...
package com.nexus.edgevox.onnx.tts.engine
...
import com.nexus.edgevox.onnx.GenerationConfig
import com.nexus.edgevox.onnx.tts.engine.ui.theme.EdgevoxOnnxTtsEngineTheme
...
const val TAG = "edgevox-onnx-tts-engine"
                                        ...
                                        onClick = {
                                            ...
                                            if (!file.exists()) {
                                                ...
                                                val uri = FileProvider.getUriForFile(
                                                    context,
                                                    "com.nexus.edgevox.onnx.tts.engine.fileprovider",
                                                    file
                                                )
