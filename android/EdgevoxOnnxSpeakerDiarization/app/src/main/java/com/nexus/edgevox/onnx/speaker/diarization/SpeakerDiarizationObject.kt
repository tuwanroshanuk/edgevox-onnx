...
import com.nexus.edgevox.onnx.FastClusteringConfig
import com.nexus.edgevox.onnx.OfflineSpeakerDiarization
import com.nexus.edgevox.onnx.OfflineSpeakerDiarizationConfig
import com.nexus.edgevox.onnx.OfflineSpeakerSegmentationModelConfig
import com.nexus.edgevox.onnx.OfflineSpeakerSegmentationPyannoteModelConfig
import com.nexus.edgevox.onnx.SpeakerEmbeddingExtractorConfig
...
/Users/fangjun/open-source/edgevox-onnx/android/EdgevoxOnnxSpeakerDiarization/app/src/main/assets
...
object SpeakerDiarizationObject {
    ...
    fun initSpeakerDiarization(assetManager: AssetManager? = null) {
        synchronized(this) {
            ...
            Log.i(TAG, "Initializing edgevox-onnx speaker diarization")
