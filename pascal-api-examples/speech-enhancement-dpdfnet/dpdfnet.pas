...
{
This file shows how to use the offline speech enhancement API from edgevox-onnx
...
begin
  ...
  EdgevoxOnnxWriteWave('./enhanced-dpdfnet.wav', Audio.Samples, Audio.SampleRate);
