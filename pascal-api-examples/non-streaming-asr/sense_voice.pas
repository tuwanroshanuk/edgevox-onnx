...
begin
  ...
  WaveFilename := './edgevox-onnx-sense-voice-zh-en-ja-ko-yue-2024-07-17/test_wavs/zh.wav';
  ...
  WriteLn(Format('edgevox-onnx version: %s', [EdgevoxOnnxGetVersionStr()]));
  WriteLn(Format('edgevox-onnx gitSha1: %s', [EdgevoxOnnxGetGitSha1()]));
  WriteLn(Format('edgevox-onnx gitDate: %s', [EdgevoxOnnxGetGitDate()]));
