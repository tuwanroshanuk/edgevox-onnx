...
var
  ...
  AllSamples: TEdgevoxOnnxSamplesArray;
...
begin
  ...
  SampleRate := 48000;
  Buffer := TEdgevoxOnnxCircularBuffer.Create(Round(SampleRate) * 20);
  ...
  EdgevoxOnnxWriteWave('record.wav', AllSamples, Round(SampleRate));
