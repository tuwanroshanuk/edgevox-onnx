...
{
This file shows how to use the Pascal API from edgevox-onnx
...
var
  ...
  Config: TEdgevoxOnnxOfflineSpeakerDiarizationConfig;
  Sd: TEdgevoxOnnxOfflineSpeakerDiarization;
  Segments: TEdgevoxOnnxOfflineSpeakerDiarizationSegmentArray;
  I: Integer;
begin
  ...
  Sd := TEdgevoxOnnxOfflineSpeakerDiarization.Create(Config);
