...
export EDGEVOX_ONNXRUNTIME_LIB_DIR=$dir/$onnxruntime_dir/lib
export EDGEVOX_ONNXRUNTIME_INCLUDE_DIR=$dir/$onnxruntime_dir/include
...
d=../harmony-os/EdgevoxOnnxHar/edgevox_onnx/src/main/cpp/libs/arm64-v8a
if [ -d $d ]; then
  cp -v install/lib/libedgevox-onnx-c-api.so $d/
