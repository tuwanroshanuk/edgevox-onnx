...
* Export X-ASR models to edgevox-onnx (#3662)
...
* Add React Native edgevox-onnx wrapper (#3615)
...
* Export nvidia/parakeet-unified-en-0.6b to edgevox-onnx (#3556)
...
* Update go.mod and go.sum for the edgevox-onnx-go package. (#3516)
...
* Add Wake Word and decibri to projects using edgevox-onnx (#3447)
* Remove num_threads assertion from OnlineRecognizer model configs (#3448)
* Add Speed of Sound to projects using edgevox-onnx (#3438)
...
* Refactor Go API examples to use edgevox_onnx.ReadWave() (#3415)
...
* Add VoxSherpa TTS to Projects using edgevox-onnx (#3384)
...
* Remove unnecessary EDGEVOX_ONNX_API from C/C++ APIs (#3295)
...
* Add fcitx5-vinput to projects using edgevox-onnx (#3350)
...
* Export Moonshine v2 models to edgevox-onnx (#3234)
...
* Change RPATH for edgevox-onnx.node (#3131)
...
* feat: Add a WebAssembly Text-to-Speech (TTS) demo with UI and worker-based audio generation using edgevox-onnx. (#3120)
...
* Export Google MedASR to edgevox-onnx (#2934)
...
* [feature] use jinja2 to generate edgevox-onnx-go lib (#2976)
...
* Export GigaAM v3 to edgevox-onnx (#2901)
...
* Begin to export omnilingual-asr to edgevox-onnx (#2770)
...
* add flet_edgevox_onnx in readme (#2663)
...
* Update README to include a ROS2 project using edgevox-onnx (#2672)
* Fix building Flutter APPs (#2673)
* Export Paraformer to RKNN (#2689)
* Update README.md add achatbot-go Projects using edgevox-onnx link (#2691)
...
* Provide pre-compiled edgevox-onnx libs/binaries for CUDA 12.x + onnxruntime 1.22.0 (#2599)
...
* Fix using edgevox-onnx as a cmake sub-project. (#2550)
...
* Export models from https://github.com/voicekit-team/T-one to edgevox-onnx (#2571)
...
* Export KittenTTS mini v0.1 to edgevox-onnx (#2578)
* Upload new sense-voice models (#2580)
* Export ASLP-lab/WSYue-ASR/tree/main/u2pp_conformer_yue to edgevox-onnx (#2582)
...
* Export whisper distil-large-v3 and distil-large-v3.5 to edgevox-onnx (#2506)
...
* Split edgevox-onnx Python package (#2521)
...
* Export https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3 to edgevox-onnx (#2500)
...
* Export https://github.com/KittenML/KittenTTS to edgevox-onnx (#2456)
...
* Fix typo in edgevox-onnx-vad-with-online-asr.cc (#2407)
* Add tail padding for edgevox-onnx-vad-with-online-asr (#2408)
...
* Add scripts for exporting Piper TTS models to edgevox-onnx (#2299)
* Update edgevox-onnx-shared.pc.in (#2300)
* Fixes #2172 (#2301)
...
* Fix building edgevox-onnx (#2262)
...
* Export nvidia/canary-180m-flash to edgevox-onnx (#2272)
...
* Add a link to YouTube video including edgevox-onnx. (#2202)
...
* export parakeet-tdt-0.6b-v2 to edgevox-onnx (#2180)
...
* Use manylinux_2_28_x86_64 to build linux gpu for edgevox-onnx (#2123)
* Support running edgevox-onnx with RK NPU on Android (#2124)
...
* Update README to include more projects using edgevox-onnx (#2022)
...
* Export vocos to edgevox-onnx (#2012)
...
* Update README to include projects that is using edgevox-onnx (#1956)
* Limit number of tokens per second for whisper. (#1958)
* Ebranchformer (#1951)
* Test using edgevox-onnx as a cmake subproject (#1961)
* Add C++ demo for VAD+non-streaming ASR (#1964)
* Export gtcrn models to edgevox-onnx (#1975)
* c-api add wave write to buffer. (#1962)
* add EdgevoxOnnxOfflineRecognizerSetConfig binding for go, and optimize the new/free for C.struct_EdgevoxOnnxOfflineRecognizerConfig ptr (#1976)
...
* Export FireRedASR to edgevox-onnx. (#1865)
...
* Update edgevox-onnx-tts.js VitsModelConfig.model can be none (#1817)
...
* Export Kokoro 1.0 to edgevox-onnx (#1788)
...
* Update readme to include https://github.com/hfyydd/edgevox-onnx-server (#1741)
...
* Export kokoro to edgevox-onnx (#1713)
...
* EdgevoxOnnxVadAsr: Offload runSecondPass to background thread for improved real-time audio processing (#1638)
...
* Provide edgevox-onnx.aar for Android (#1615)
...
* Publish `edgevox_onnx.har` for HarmonyOS (#1572)
...
* Support building GPU-capable edgevox-onnx on Linux aarch64. (#1500)
...
* Update readme to include more external projects using edgevox-onnx (#1405)
...
* Fix edgevox_onnx.go to support returning empty recognition results (#1353)

## 1.10.26

* Add links to projects using edgevox-onnx. (#1345)
...
* Avoid EdgevoxOnnxSpeakerEmbeddingManagerFreeBestMatches freeing null. (#1296)
...
* Prefix all C API functions with EdgevoxOnnx
...
* Build edgevox-onnx into a single shared library.
