...
if [ ! -f "./ten-vad.onnx" ]; then
  curl -SLf -O https://github.com/k2-fsa/edgevox-onnx/releases/download/asr-models/ten-vad.onnx
fi

if [ ! -f ./lei-jun-test.wav ]; then
  curl -SLf -O https://github.com/k2-fsa/edgevox-onnx/releases/download/asr-models/lei-jun-test.wav
fi
