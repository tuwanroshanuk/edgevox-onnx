...
# see
# https://k2-fsa.github.io/sherpa/onnx/pretrained_models/offline-ctc/zipformer-ctc-models.html#edgevox-onnx-zipformer-ctc-zh-int8-2025-07-03-chinese
if [ ! -f ./edgevox-onnx-zipformer-ctc-zh-int8-2025-07-03/model.int8.onnx ]; then
  curl -SsL -O https://github.com/k2-fsa/edgevox-onnx/releases/download/asr-models/edgevox-onnx-zipformer-ctc-zh-int8-2025-07-03.tar.bz2
