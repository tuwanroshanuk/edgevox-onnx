...
//
// This file demonstrates how to use edgevox-onnx's Rust API for offline
// punctuation.
//
// See ../README.md for how to run it.

use clap::Parser;
use edgevox_onnx::{OfflinePunctuation, OfflinePunctuationConfig, OfflinePunctuationModelConfig};
