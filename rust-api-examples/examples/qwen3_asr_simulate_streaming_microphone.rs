...
//
// This file demonstrates how to use Qwen3 ASR with edgevox-onnx's
...
// Qwen3 ASR recognizer on each detected segment, providing an experience
...
use edgevox_onnx::{
    DisplayManager, LinearResampler, OfflineQwen3ASRModelConfig, OfflineRecognizer,
    OfflineRecognizerConfig, VadModelConfig, VoiceActivityDetector,
};
...
fn create_recognizer(args: &Args) -> OfflineRecognizer {
    ...
    config.model_config.qwen3_asr = OfflineQwen3ASRModelConfig {
        conv_frontend: Some(args.conv_frontend.clone()),
