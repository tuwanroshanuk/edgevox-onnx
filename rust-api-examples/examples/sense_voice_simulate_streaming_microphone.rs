...
//
// This file demonstrates how to use sense voice with edgevox-onnx's
...
//
// See ./sense_voice.rs for how to recognize a wave file.
...
fn create_recognizer(args: &Args) -> OfflineRecognizer {
    ...
    config.model_config.sense_voice.model = Some(args.model.clone());
