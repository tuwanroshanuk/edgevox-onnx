...
//
// This file demonstrates how to use Zipformer CTC with edgevox-onnx's
...
// Zipformer CTC recognizer on each detected segment, providing an experience
...
fn create_recognizer(args: &Args) -> OfflineRecognizer {
    ...
    config.model_config.zipformer_ctc.model = Some(args.model.clone());
