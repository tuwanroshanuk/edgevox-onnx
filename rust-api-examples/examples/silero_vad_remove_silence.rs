...
//
// This file demonstrates how to use silero VAD with edgevox-onnx's
// Rust API to remove non-speech segments and save speech-only audio.
//
// See ../README.md for how to run it

use clap::Parser;
use edgevox_onnx::{self, SileroVadModelConfig, VadModelConfig, VoiceActivityDetector, Wave};
...
fn main() -> anyhow::Result<()> {
    ...
    let ok = edgevox_onnx::write(&args.output, &speech_samples, sample_rate);
    if ok {
