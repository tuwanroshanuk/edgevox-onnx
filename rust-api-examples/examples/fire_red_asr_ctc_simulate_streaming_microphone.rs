...
//
// This file demonstrates how to use FireRedASR CTC with edgevox-onnx's
...
// FireRedASR CTC recognizer on each detected segment, providing an experience
...
fn create_recognizer(args: &Args) -> OfflineRecognizer {
    ...
    config.model_config.fire_red_asr_ctc.model = Some(args.model.clone());
