...
//
// This file demonstrates how to use streaming Zipformer with edgevox-onnx's
...
use edgevox_onnx::{DisplayManager, OnlineRecognizer, OnlineRecognizerConfig};
use std::sync::mpsc;
...
fn run_recognition_loop(
    ...
    stream: &mut edgevox_onnx::OnlineStream,
    chunk_size: usize,
    sample_rate: i32,
) {
