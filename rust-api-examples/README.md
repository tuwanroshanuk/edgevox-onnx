...
This folder contains examples that use the `edgevox-onnx` Rust crate maintained in
this repository.
...
The first build may download the matching edgevox-onnx native libraries for your
...
If you want to customize which libraries are used, set `EDGEVOX_ONNX_LIB_DIR`,
...
| # | Example | Description |
|---|---------|-------------|
| 1 | [version](#example-1-show-edgevox-onnx-version) | Show the edgevox-onnx version |
...
### Example 1: Show edgevox-onnx version
