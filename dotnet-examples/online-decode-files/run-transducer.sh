...
dotnet run -c Release \
  ...
  --files ./edgevox-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20/test_wavs/1.wav \
  ./edgevox-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20/test_wavs/0.wav \
