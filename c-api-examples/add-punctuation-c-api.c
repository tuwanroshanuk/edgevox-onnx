...
int32_t main() {
  ...
  // clang-format off
  config.model.ct_transformer = "./edgevox-onnx-punct-ct-transformer-zh-en-vocab272727-2024-04-12-int8/model.int8.onnx";
  // clang-format on
