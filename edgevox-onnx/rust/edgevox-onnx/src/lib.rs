//! Safe Rust bindings for the public edgevox-onnx inference APIs.
//!
//! This crate wraps the edgevox-onnx C API with RAII-owned Rust types and
...
//! ```
//!
//! For advanced use cases, set `EDGEVOX_ONNX_LIB_DIR` to a directory that already
//! contains edgevox-onnx libraries:
//!
//! ```bash
...
//! `DYLD_LIBRARY_PATH`.
//!
//! Example `v1.13.4` archives used by the build script:
//!
...
//!
//! ```no_run
//! use edgevox_onnx::{OfflineTts, OfflineTtsConfig, OfflineTtsModelConfig, OfflineTtsPocketModelConfig};
//!
