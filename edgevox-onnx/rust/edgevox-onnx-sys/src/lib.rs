...
extern "C" {
    pub fn EdgevoxOnnxGetVersionStr() -> *const c_char;
    pub fn EdgevoxOnnxGetGitSha1() -> *const c_char;
    pub fn EdgevoxOnnxGetGitDate() -> *const c_char;
    pub fn EdgevoxOnnxFileExists(filename: *const c_char) -> i32;
}
