...
The generated jar will be in `target/edgevox-onnx-jvm-<version>.jar`.
...
| File | Description |
|---|---|
| `target/edgevox-onnx-jvm-1.13.4.jar` | JVM API jar (classes only) |
...
javac -cp edgevox-onnx/java-api/target/edgevox-onnx-jvm-1.13.4.jar YourApp.java

# Run your code (with JNI library path)
java -Djava.library.path=/path/to/jni/libs -cp edgevox-onnx/java-api/target/edgevox-onnx-jvm-1.13.4.jar YourApp
```
