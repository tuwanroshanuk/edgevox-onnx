// edgevox-onnx/python/csrc/offline-model-config.cc
//
...
#include "edgevox-onnx/python/csrc/offline-canary-model-config.h"
#include "edgevox-onnx/python/csrc/offline-cohere-transcribe-model-config.h"
#include "edgevox-onnx/python/csrc/offline-dolphin-model-config.h"
#include "edgevox-onnx/python/csrc/offline-fire-red-asr-ctc-model-config.h"
#include "edgevox-onnx/python/csrc/offline-fire-red-asr-model-config.h"
#include "edgevox-onnx/python/csrc/offline-funasr-nano-model-config.h"
#include "edgevox-onnx/python/csrc/offline-medasr-ctc-model-config.h"
#include "edgevox-onnx/python/csrc/offline-qwen3-asr-model-config.h"
#include "edgevox-onnx/python/csrc/offline-moonshine-model-config.h"
...
#include "edgevox-onnx/python/csrc/offline-transducer-model-config.h"
#include "edgevox-onnx/python/csrc/offline-wenet-ctc-model-config.h"
#include "edgevox-onnx/python/csrc/offline-whisper-model-config.h"
#include "edgevox-onnx/python/csrc/offline-zipformer-ctc-model-config.h"
