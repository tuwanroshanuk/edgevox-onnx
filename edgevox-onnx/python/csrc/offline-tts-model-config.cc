// edgevox-onnx/python/csrc/offline-tts-model-config.cc
//
// Copyright (c)  2023  Xiaomi Corporation

#include "edgevox-onnx/python/csrc/offline-tts-model-config.h"
...
#include "edgevox-onnx/python/csrc/offline-tts-supertonic-model-config.h"
#include "edgevox-onnx/python/csrc/offline-tts-vits-model-config.h"
#include "edgevox-onnx/python/csrc/offline-tts-zipvoice-model-config.h"
