// edgevox-onnx/python/csrc/offline-source-separation-model-config.cc
//
// Copyright (c)  2025  Xiaomi Corporation

#include "edgevox-onnx/python/csrc/offline-source-separation-model-config.h"

#include <string>

#include "edgevox-onnx/csrc/offline-source-separation-model-config.h"
#include "edgevox-onnx/python/csrc/offline-source-separation-spleeter-model-config.h"
