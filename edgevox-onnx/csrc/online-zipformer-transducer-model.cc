// edgevox-onnx/csrc/online-zipformer-transducer-model.cc
//
// Copyright (c)  2023  Xiaomi Corporation

#include "edgevox-onnx/csrc/online-zipformer-transducer-model.h"
...
void OnlineZipformerTransducerModel::InitEncoder(void *model_data,
  ...
  EDGEVOX_ONNX_READ_META_DATA_VEC(attention_dims_, "attention_dims");
