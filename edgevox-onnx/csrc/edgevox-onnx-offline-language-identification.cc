// edgevox-onnx/csrc/edgevox-onnx-offline-language-identification.cc
//
...
Spoken language identification with edgevox-onnx.
...
for a list of pre-trained models to download.
  ...
  edgevox_onnx::SpokenLanguageIdentificationConfig config;
  config.Register(&po);
  ...
  edgevox_onnx::SpokenLanguageIdentification slid(config);
