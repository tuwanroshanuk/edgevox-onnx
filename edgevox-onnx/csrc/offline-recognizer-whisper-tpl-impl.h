// edgevox-onnx/csrc/offline-recognizer-whisper-tpl-impl.h
//
// Copyright (c)  2026  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_WHISPER_TPL_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_WHISPER_TPL_IMPL_H_
 ...
 private:
  void Init() {
    ...
    if (config_.decoding_method == "greedy_search") {
      EDGEVOX_ONNX_LOGE("use greedy_search");
    } else {
      EDGEVOX_ONNX_LOGE(
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_WHISPER_TPL_IMPL_H_
