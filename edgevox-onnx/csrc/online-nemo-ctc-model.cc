// edgevox-onnx/csrc/online-nemo-ctc-model.cc
//
// Copyright (c)  2023  Xiaomi Corporation

#include "edgevox-onnx/csrc/online-nemo-ctc-model.h"
 ...
 public:
  explicit Impl(const OnlineModelConfig &config)
    ...
    sess_ = std::make_unique<Ort::Session>(
        env_, EDGEVOX_ONNX_TO_ORT_PATH(config.nemo_ctc.model), sess_opts_);
    Init(nullptr, 0);
  }
