// edgevox-onnx/csrc/online-ctc-model.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_ONLINE_CTC_MODEL_H_
#define EDGEVOX_ONNX_CSRC_ONLINE_CTC_MODEL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_ONLINE_CTC_MODEL_H_
