// edgevox-onnx/csrc/spoken-language-identification-whisper-impl.h
//
// Copyright (c)  2024  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_SPOKEN_LANGUAGE_IDENTIFICATION_WHISPER_IMPL_H_
#define EDGEVOX_ONNX_CSRC_SPOKEN_LANGUAGE_IDENTIFICATION_WHISPER_IMPL_H_
...
#include "edgevox-onnx/csrc/spoken-language-identification-impl.h"
  ...
  std::string Compute(OfflineStream *s) const override {
    ...
    try {
      ...
      if (id2lang.count(lang_id)) {
        ...
        EDGEVOX_ONNX_LOGE("Unknown language ID: %d. Return an empty string.",
                         lang_id);
        return "";
      }
...
#endif  // EDGEVOX_ONNX_CSRC_SPOKEN_LANGUAGE_IDENTIFICATION_WHISPER_IMPL_H_
