// edgevox-onnx/csrc/silero-vad-model.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_SILERO_VAD_MODEL_H_
#define EDGEVOX_ONNX_CSRC_SILERO_VAD_MODEL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_SILERO_VAD_MODEL_H_
