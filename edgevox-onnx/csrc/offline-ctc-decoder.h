// edgevox-onnx/csrc/offline-ctc-decoder.h
//
// Copyright (c)  2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_CTC_DECODER_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_CTC_DECODER_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_CTC_DECODER_H_
