// edgevox-onnx/csrc/rknn/online-recognizer-transducer-rknn-impl.h
//
// Copyright (c)  2025  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_RKNN_ONLINE_RECOGNIZER_TRANSDUCER_RKNN_IMPL_H_
#define EDGEVOX_ONNX_CSRC_RKNN_ONLINE_RECOGNIZER_TRANSDUCER_RKNN_IMPL_H_
...
#include "edgevox-onnx/csrc/rknn/online-transducer-modified-beam-search-decoder-rknn.h"
...
class OnlineRecognizerTransducerRknnImpl : public OnlineRecognizerImpl {
 public:
  ...
  std::unique_ptr<OnlineStream> CreateStream(
    ...
    EDGEVOX_ONNX_LOGE("Hotwords for RKNN is not supported now.");
    return CreateStream();
  }
...
#endif  // EDGEVOX_ONNX_CSRC_RKNN_ONLINE_RECOGNIZER_TRANSDUCER_RKNN_IMPL_H_
