// edgevox-onnx/csrc/rknn/online-zipformer-ctc-model-rknn.cc
//
// Copyright (c)  2025  Xiaomi Corporation

#include "edgevox-onnx/csrc/rknn/online-zipformer-ctc-model-rknn.h"
 ...
 private:
  void Init(void *model_data, size_t model_data_length) {
    ...
    if (config_.debug) {
      ...
      EDGEVOX_ONNX_LOGE("vocab_size: %{public}d", vocab_size);
#else
