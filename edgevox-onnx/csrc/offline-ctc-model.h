// edgevox-onnx/csrc/offline-ctc-model.h
//
// Copyright (c)  2022-2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_CTC_MODEL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_CTC_MODEL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_CTC_MODEL_H_
