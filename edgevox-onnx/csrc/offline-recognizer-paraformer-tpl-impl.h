// edgevox-onnx/csrc/offline-recognizer-paraformer-tpl-impl.h
//
// Copyright (c)  2025  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_PARAFORMER_TPL_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_PARAFORMER_TPL_IMPL_H_
...
class OfflineRecognizerParaformerTplImpl : public OfflineRecognizerImpl {
 ...
 private:
  ...
  void DecodeOneStream(OfflineStream *s) const {
    ...
    if (logits.empty()) {
      EDGEVOX_ONNX_LOGE("No speech detected");
      return;
    }
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_PARAFORMER_TPL_IMPL_H_
