// edgevox-onnx/csrc/online-model-config.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_ONLINE_MODEL_CONFIG_H_
#define EDGEVOX_ONNX_CSRC_ONLINE_MODEL_CONFIG_H_
...
#endif  // EDGEVOX_ONNX_CSRC_ONLINE_MODEL_CONFIG_H_
