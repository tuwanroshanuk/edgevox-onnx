// edgevox-onnx/csrc/online-websocket-server-impl.h
//
// Copyright (c)  2022-2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_ONLINE_WEBSOCKET_SERVER_IMPL_H_
#define EDGEVOX_ONNX_CSRC_ONLINE_WEBSOCKET_SERVER_IMPL_H_
...
#include "edgevox-onnx/csrc/tee-stream.h"
...
struct OnlineWebsocketServerConfig {
  ...
  void Register(edgevox_onnx::ParseOptions *po);
  void Validate() const;
};
...
#endif  // EDGEVOX_ONNX_CSRC_ONLINE_WEBSOCKET_SERVER_IMPL_H_
