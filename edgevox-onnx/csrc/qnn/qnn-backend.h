// edgevox-onnx/csrc/qnn/qnn-backend.h
//
// Copyright (c)  2025  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_QNN_QNN_BACKEND_H_
#define EDGEVOX_ONNX_CSRC_QNN_QNN_BACKEND_H_
...
#endif  // EDGEVOX_ONNX_CSRC_QNN_QNN_BACKEND_H_
