// edgevox-onnx/csrc/qnn/utils.h
//
// Copyright (c)  2025  Xiaomi Corporation
#include "edgevox-onnx/csrc/qnn/utils.h"
...
#include "edgevox-onnx/csrc/qnn/macros.h"

#define EDGEVOX_ONNX_TO_STRING(s) \
  case s:                        \
    return #s

std::string TensorTypeToString(Qnn_TensorType_t t) {
  switch (t) {
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_APP_WRITE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_APP_READ);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_APP_READWRITE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_NATIVE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_STATIC);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_NULL);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_UPDATEABLE_STATIC);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_UPDATEABLE_NATIVE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_UPDATEABLE_APP_WRITE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_UPDATEABLE_APP_READ);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_UPDATEABLE_APP_READWRITE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_OPTIONAL_APP_WRITE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_OPTIONAL_APP_READ);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_OPTIONAL_APP_READWRITE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSOR_TYPE_UNDEFINED);
  }
  return "Unknown";
}
...
std::string QuantizationEncodingToString(Qnn_QuantizationEncoding_t q) {
  switch (q) {
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_SCALE_OFFSET);
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_AXIS_SCALE_OFFSET);
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_BW_SCALE_OFFSET);
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_BW_AXIS_SCALE_OFFSET);
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_BLOCK);
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_BLOCKWISE_EXPANSION);
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_VECTOR);
    EDGEVOX_ONNX_TO_STRING(QNN_QUANTIZATION_ENCODING_UNDEFINED);
    default:
      return "Unknown";
  }
}
...
std::string TensorDataTypeToString(Qnn_DataType_t t) {
  switch (t) {
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_INT_8);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_INT_16);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_INT_32);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_INT_64);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UINT_8);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UINT_16);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UINT_32);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UINT_64);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_FLOAT_16);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_FLOAT_32);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_FLOAT_64);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_SFIXED_POINT_4);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_SFIXED_POINT_8);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_SFIXED_POINT_16);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_SFIXED_POINT_32);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UFIXED_POINT_4);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UFIXED_POINT_8);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UFIXED_POINT_16);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UFIXED_POINT_32);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_BOOL_8);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_STRING);
    EDGEVOX_ONNX_TO_STRING(QNN_DATATYPE_UNDEFINED);
  }
  return "unknown";
}
...
std::string TensorMemTypeToString(Qnn_TensorMemType_t t) {
  switch (t) {
    EDGEVOX_ONNX_TO_STRING(QNN_TENSORMEMTYPE_RAW);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSORMEMTYPE_MEMHANDLE);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSORMEMTYPE_RETRIEVE_RAW);
    EDGEVOX_ONNX_TO_STRING(QNN_TENSORMEMTYPE_UNDEFINED);
  }
  return "Unknown";
}

#undef EDGEVOX_ONNX_TO_STRING
...
void FreeTensor(Qnn_Tensor_t *t) {
  if (t->version == QNN_TENSOR_VERSION_1) {
    ...
    EDGEVOX_ONNX_LOGE("Unknown tensor version: %d", t->version);
  }
}
...
uint32_t GetSizeInBytes(const uint32_t *dimensions, uint32_t n,
  ...
  switch (type) {
    ...
    case QNN_DATATYPE_BOOL_8:
      ...
      break;
    default:
      EDGEVOX_ONNX_LOGE("Unsupported data type: %s",
...
static void CopyTensorInfoV1(const Qnn_Tensor_t &src,
  ...
  if (dst.v1.memType != QNN_TENSORMEMTYPE_RAW) {
    EDGEVOX_ONNX_LOGE("Unsupported mem type: %s",
...
void CopyTensorInfo(const Qnn_Tensor_t &src, Qnn_Tensor_t &dst) {  // NOLINT
  if (src.version == QNN_TENSOR_VERSION_1) {
    ...
    EDGEVOX_ONNX_LOGE("Unknown tensor version: %d", dst.version);
  }
}
...
static bool CopyGraphsInfo(const QnnSystemContext_GraphInfo_t *graphs_input,
  ...
  if (num_graphs == 0) {
    EDGEVOX_ONNX_LOGE("empty graphs");
    graphs_info = nullptr;
    return false;
  }

  EDGEVOX_ONNX_LOGE("version: %d", (int)graphs_input[0].version);
  ...
  if (!graphs_info || !graph_info_arr) {
    EDGEVOX_ONNX_LOGE("Failure to allocate memory for *graphInfo");
    return false;
  }
  ...
  for (uint32_t i = 0; i < num_graphs; ++i) {
    switch (graphs_input[i].version) {
      case QNN_SYSTEM_CONTEXT_GRAPH_INFO_VERSION_1:
        EDGEVOX_ONNX_LOGE("Unsupported version: %d",
      ...
      case QNN_SYSTEM_CONTEXT_GRAPH_INFO_VERSION_3: {
        ...
        if (!ok) {
          EDGEVOX_ONNX_LOGE("Failed to copy graphs info v3");
        }
...
bool CopyMetadataToGraphsInfo(const QnnSystemContext_BinaryInfo_t *binary_info,
  ...
  switch (binary_info->version) {
    case QNN_SYSTEM_CONTEXT_BINARY_INFO_VERSION_1: {
      EDGEVOX_ONNX_LOGE("Unsupported binary context version: %d",
                       binary_info->version);
      return false;
    }
    ...
    case QNN_SYSTEM_CONTEXT_BINARY_INFO_VERSION_3: {
      ...
      if (!ok) {
        EDGEVOX_ONNX_LOGE("Failed while copying graphs Info v3.");
        return false;
      }
