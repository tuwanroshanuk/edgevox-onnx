// edgevox-onnx/csrc/qnn/online-recognizer-zipformer-transducer-qnn-impl.h
//
// Copyright (c)  2026  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_QNN_ONLINE_RECOGNIZER_ZIPFORMER_TRANSDUCER_QNN_IMPL_H_
#define EDGEVOX_ONNX_CSRC_QNN_ONLINE_RECOGNIZER_ZIPFORMER_TRANSDUCER_QNN_IMPL_H_
...
#include "edgevox-onnx/csrc/endpoint.h"
...
class OnlineRecognizerZipformerTransducerQnnImpl
 ...
 public:
  ...
  std::unique_ptr<OnlineStream> CreateStream(
    ...
    if (!hotwords.empty()) {
      EDGEVOX_ONNX_LOGE("hotwords are not supported with qnn transducers");
      EDGEVOX_ONNX_EXIT(-1);
    }
    return CreateStream();
  }
 ...
 private:
  ...
  OnlineTransducerDecoderResultNoOrt GetEmptyResult() const {
    ...
    if (config_.decoding_method == "greedy_search") {
      ...
      EDGEVOX_ONNX_LOGE("Unsupported decoding method for qnn transducer: %s",
...
#endif  // EDGEVOX_ONNX_CSRC_QNN_ONLINE_RECOGNIZER_ZIPFORMER_TRANSDUCER_QNN_IMPL_H_
