// edgevox-onnx/csrc/qnn/offline-recognizer-parakeet-tdt-qnn-impl.h
//
// Copyright (c)  2026  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_QNN_OFFLINE_RECOGNIZER_PARAKEET_TDT_QNN_IMPL_H_
#define EDGEVOX_ONNX_CSRC_QNN_OFFLINE_RECOGNIZER_PARAKEET_TDT_QNN_IMPL_H_
 ...
 private:
  void Init() {
    ...
    if (config_.model_config.debug) {
      EDGEVOX_ONNX_LOGE("blank_id: %d", blank_id);
      EDGEVOX_ONNX_LOGE("vocab_size: %d", vocab_size);
      EDGEVOX_ONNX_LOGE("subsampling_factor: %d", model_->SubsamplingFactor());
      EDGEVOX_ONNX_LOGE("encoder_dim: %d", model_->EncoderDim());
      EDGEVOX_ONNX_LOGE("feat_dim: %d", feat_dim);
    }
  }
...
#endif  // EDGEVOX_ONNX_CSRC_QNN_OFFLINE_RECOGNIZER_PARAKEET_TDT_QNN_IMPL_H_
