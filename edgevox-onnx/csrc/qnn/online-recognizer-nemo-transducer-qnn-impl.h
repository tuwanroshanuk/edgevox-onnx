// edgevox-onnx/csrc/qnn/online-recognizer-nemo-transducer-qnn-impl.h
//
// Copyright (c)  2026  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_QNN_ONLINE_RECOGNIZER_NEMO_TRANSDUCER_QNN_IMPL_H_
#define EDGEVOX_ONNX_CSRC_QNN_ONLINE_RECOGNIZER_NEMO_TRANSDUCER_QNN_IMPL_H_
...
class OnlineRecognizerNemoTransducerQnnImpl : public OnlineRecognizerImpl {
 public:
  ...
  std::unique_ptr<OnlineStream> CreateStream(
    ...
    if (!hotwords.empty()) {
      EDGEVOX_ONNX_LOGE("hotwords are not supported with qnn nemo transducer");
      EDGEVOX_ONNX_EXIT(-1);
    }
    return CreateStream();
  }
...
#endif  // EDGEVOX_ONNX_CSRC_QNN_ONLINE_RECOGNIZER_NEMO_TRANSDUCER_QNN_IMPL_H_
