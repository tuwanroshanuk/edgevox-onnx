// edgevox-onnx/csrc/offline-qwen3-asr-model.h
//
// Copyright (c)  2026  zengyw

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_QWEN3_ASR_MODEL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_QWEN3_ASR_MODEL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_QWEN3_ASR_MODEL_H_
