// edgevox-onnx/csrc/pad-sequence.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_PAD_SEQUENCE_H_
#define EDGEVOX_ONNX_CSRC_PAD_SEQUENCE_H_
...
#endif  // EDGEVOX_ONNX_CSRC_PAD_SEQUENCE_H_
