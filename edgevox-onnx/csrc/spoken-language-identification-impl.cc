// edgevox-onnx/csrc/spoken-language-identification-impl.cc
//
...
#include "edgevox-onnx/csrc/spoken-language-identification-whisper-impl.h"
...
SpokenLanguageIdentificationImpl::Create(
  ...
  ModelType model_type = ModelType::kUnknown;
  {
    if (config.whisper.encoder.empty()) {
      EDGEVOX_ONNX_LOGE("Only whisper models are supported at present");
      EDGEVOX_ONNX_EXIT(-1);
    }
