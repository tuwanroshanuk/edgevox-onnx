// edgevox-onnx/csrc/offline-ctc-model.cc
//
// Copyright (c)  2022-2023  Xiaomi Corporation

#include "edgevox-onnx/csrc/offline-ctc-model.h"
...
#include "edgevox-onnx/csrc/offline-dolphin-model.h"
#include "edgevox-onnx/csrc/offline-fire-red-asr-ctc-model.h"
#include "edgevox-onnx/csrc/offline-medasr-ctc-model.h"
#include "edgevox-onnx/csrc/offline-nemo-enc-dec-ctc-model.h"
#include "edgevox-onnx/csrc/offline-omnilingual-asr-ctc-model.h"
#include "edgevox-onnx/csrc/offline-tdnn-ctc-model.h"
#include "edgevox-onnx/csrc/offline-telespeech-ctc-model.h"
#include "edgevox-onnx/csrc/offline-wenet-ctc-model.h"
#include "edgevox-onnx/csrc/offline-zipformer-ctc-model.h"
...
static ModelType GetModelType(const std::string &model_path, bool debug) {
  ...
  if (model_type.empty()) {
    EDGEVOX_ONNX_LOGE(
        ...
        "or "
        "https://github.com/k2-fsa/edgevox-onnx/tree/master/scripts/nemo/"
        "fast-conformer-hybrid-transducer-ctc\n"
        "If you are using models from WeNet, please refer to\n"
        "https://github.com/k2-fsa/edgevox-onnx/blob/master/scripts/wenet/"
        "run.sh\n"
        "If you are using models from TeleSpeech, please refer to\n"
        "https://github.com/k2-fsa/edgevox-onnx/blob/master/scripts/tele-speech/"
        "add-metadata.py"
        "\n"
...
std::unique_ptr<OfflineCtcModel> OfflineCtcModel::Create(
  ...
  if (!config.nemo_ctc.model.empty()) {
    ...
    EDGEVOX_ONNX_LOGE("Please specify a CTC model");
    EDGEVOX_ONNX_EXIT(-1);
  }
  ...
  switch (model_type) {
    ...
    case ModelType::kUnknown:
      EDGEVOX_ONNX_LOGE("Unknown model type in offline CTC!");
      return nullptr;
  }
