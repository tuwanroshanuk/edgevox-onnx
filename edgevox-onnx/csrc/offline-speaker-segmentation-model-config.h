// edgevox-onnx/csrc/offline-speaker-segmentation-model-config.h
//
// Copyright (c)  2024  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_SPEAKER_SEGMENTATION_MODEL_CONFIG_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_SPEAKER_SEGMENTATION_MODEL_CONFIG_H_

#include <string>

#include "edgevox-onnx/csrc/offline-speaker-segmentation-pyannote-model-config.h"
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_SPEAKER_SEGMENTATION_MODEL_CONFIG_H_
