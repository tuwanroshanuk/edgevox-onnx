// edgevox-onnx/csrc/edgevox-onnx-vad-with-online-asr.cc
//
...
Speech recognition using VAD + streaming models with edgevox-onnx-vad-with-online-asr.
...
for a list of pre-trained models to download.
  ...
  edgevox_onnx::OnlineRecognizerConfig asr_config;
  ...
  edgevox_onnx::OnlineRecognizer recognizer(asr_config);
