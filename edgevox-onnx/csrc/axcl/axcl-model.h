// edgevox-onnx/csrc/axcl/axcl-model.h
//
// Copyright (c)  2025  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_AXCL_AXCL_MODEL_H_
#define EDGEVOX_ONNX_CSRC_AXCL_AXCL_MODEL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_AXCL_AXCL_MODEL_H_
