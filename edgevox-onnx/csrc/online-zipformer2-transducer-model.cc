// edgevox-onnx/csrc/online-zipformer2-transducer-model.cc
//
// Copyright (c)  2023  Xiaomi Corporation

#include "edgevox-onnx/csrc/online-zipformer2-transducer-model.h"
...
void OnlineZipformer2TransducerModel::InitEncoder(void *model_data,
  ...
  EDGEVOX_ONNX_READ_META_DATA_VEC(encoder_dims_, "encoder_dims");
  EDGEVOX_ONNX_READ_META_DATA_VEC(query_head_dims_, "query_head_dims");
  EDGEVOX_ONNX_READ_META_DATA_VEC(value_head_dims_, "value_head_dims");
  EDGEVOX_ONNX_READ_META_DATA_VEC(num_heads_, "num_heads");
  EDGEVOX_ONNX_READ_META_DATA_VEC(num_encoder_layers_, "num_encoder_layers");
  EDGEVOX_ONNX_READ_META_DATA_VEC(cnn_module_kernels_, "cnn_module_kernels");
  EDGEVOX_ONNX_READ_META_DATA_VEC(left_context_len_, "left_context_len");

  EDGEVOX_ONNX_READ_META_DATA(T_, "T");
  EDGEVOX_ONNX_READ_META_DATA(decode_chunk_len_, "decode_chunk_len");

  std::string feature_type;
  EDGEVOX_ONNX_READ_META_DATA_STR_WITH_DEFAULT(feature_type, "feature", "");
...
OnlineZipformer2TransducerModel::GetEncoderInitStates() {
  ...
  {
    EDGEVOX_ONNX_CHECK_NE(feature_dim_, 0);
