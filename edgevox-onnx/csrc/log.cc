// edgevox-onnx/csrc/log.cc
//
// Copyright (c)  2023  Xiaomi Corporation

#include "edgevox-onnx/csrc/log.h"

#ifdef EDGEVOX_ONNX_HAVE_EXECINFO_H
#include <execinfo.h>  // To get stack trace in error messages.
#ifdef EDGEVOX_ONNX_HAVE_CXXABI_H
#include <cxxabi.h>  // For name demangling.
// Useful to decode the stack trace, but only used if we have execinfo.h
#endif  // EDGEVOX_ONNX_HAVE_CXXABI_H
#endif  // EDGEVOX_ONNX_HAVE_EXECINFO_H
...
#ifndef EDGEVOX_ONNX_HAVE_CXXABI_H
  return trace_name;
#else   // EDGEVOX_ONNX_HAVE_CXXABI_H
