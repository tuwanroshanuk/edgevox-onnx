// edgevox-onnx/csrc/online-recognizer-transducer-nemo-parakeet-unified-impl.h
//
// Copyright (c)  2026  Milan Leonard

#ifndef EDGEVOX_ONNX_CSRC_ONLINE_RECOGNIZER_TRANSDUCER_NEMO_PARAKEET_UNIFIED_IMPL_H_
#define EDGEVOX_ONNX_CSRC_ONLINE_RECOGNIZER_TRANSDUCER_NEMO_PARAKEET_UNIFIED_IMPL_H_
...
#include "edgevox-onnx/csrc/online-transducer-greedy-search-nemo-parakeet-unified-decoder.h"
 ...
 private:
  ...
  void PostInit() {
    ...
    if (model_->FeatureNormalizationMethod() != "per_feature" &&
      ...
      EDGEVOX_ONNX_LOGE("Unsupported NeMo Parakeet Unified normalization: %s",
...
#endif  // EDGEVOX_ONNX_CSRC_ONLINE_RECOGNIZER_TRANSDUCER_NEMO_PARAKEET_UNIFIED_IMPL_H_
