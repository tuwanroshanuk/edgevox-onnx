// edgevox-onnx/csrc/offline-whisper-dtw.h
//
// Copyright (c)  2026  Posit Software, PBC

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_WHISPER_DTW_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_WHISPER_DTW_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_WHISPER_DTW_H_
