// edgevox-onnx/csrc/online-nemo-ctc-model.h
//
// Copyright (c)  2024  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_ONLINE_NEMO_CTC_MODEL_H_
#define EDGEVOX_ONNX_CSRC_ONLINE_NEMO_CTC_MODEL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_ONLINE_NEMO_CTC_MODEL_H_
