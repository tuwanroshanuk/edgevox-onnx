// edgevox-onnx/csrc/keyword-spotter.cc
//
...
bool KeywordSpotterConfig::Validate() const {
...
#ifndef EDGEVOX_ONNX_ENABLE_WASM_KWS
  // due to the limitations of the wasm file system,
  // keywords file will be packaged into the edgevox-onnx-wasm-kws-main.data file
  ...
  if (keywords_buf.empty() && !FileExists(keywords_file)) {
    EDGEVOX_ONNX_LOGE("Keywords file '%s' does not exist.",
                     keywords_file.c_str());
    return false;
  }
#endif
