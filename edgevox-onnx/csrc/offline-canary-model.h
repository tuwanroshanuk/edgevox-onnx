// edgevox-onnx/csrc/offline-canary-model.h
//
// Copyright (c)  2025  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_CANARY_MODEL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_CANARY_MODEL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_CANARY_MODEL_H_
