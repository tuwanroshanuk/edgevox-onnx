// edgevox-onnx/csrc/offline-punctuation-impl.cc
//
...
#include "edgevox-onnx/csrc/offline-punctuation-ct-transformer-impl.h"
...
std::unique_ptr<OfflinePunctuationImpl> OfflinePunctuationImpl::Create(
  ...
  EDGEVOX_ONNX_LOGE("Please specify a punctuation model! Return a null pointer");
  return nullptr;
}
