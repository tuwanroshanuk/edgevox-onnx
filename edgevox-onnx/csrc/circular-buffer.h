// edgevox-onnx/csrc/circular-buffer.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_CIRCULAR_BUFFER_H_
#define EDGEVOX_ONNX_CSRC_CIRCULAR_BUFFER_H_
...
#endif  // EDGEVOX_ONNX_CSRC_CIRCULAR_BUFFER_H_
