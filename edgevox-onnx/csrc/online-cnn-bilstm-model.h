// edgevox-onnx/csrc/online-cnn-bilstm-model.h
//
// Copyright (c) 2024 Jian You (jianyou@cisco.com, Cisco Systems)

#ifndef EDGEVOX_ONNX_CSRC_ONLINE_CNN_BILSTM_MODEL_H_
#define EDGEVOX_ONNX_CSRC_ONLINE_CNN_BILSTM_MODEL_H_
#include <memory>
#include <utility>
...
#endif  // EDGEVOX_ONNX_CSRC_ONLINE_CNN_BILSTM_MODEL_H_
