// edgevox-onnx/csrc/offline-tts-impl.h
//
// Copyright (c)  2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_TTS_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_TTS_IMPL_H_
...
class OfflineTtsImpl {
 public:
  ...
  virtual GeneratedAudio Generate(
    ...
    EDGEVOX_ONNX_LOGE("Not implemented yet. Only some models support this");
    EDGEVOX_ONNX_LOGE("Please use edgevox-onnx > v1.12.30");
    return {};
  }
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_TTS_IMPL_H_
