// edgevox-onnx/csrc/edgevox-onnx-offline.cc
//
...
Speech recognition using non-streaming models with edgevox-onnx.
...
See https://k2-fsa.github.io/sherpa/onnx/pretrained_models/offline-ctc/yesno/index.html
      //
  ./build/bin/edgevox-onnx-offline \
    --sample-rate=8000 \
    --feat-dim=23 \
...
for a list of pre-trained models to download.
  ...
  edgevox_onnx::OfflineRecognizer recognizer(config);
  ...
  std::vector<std::unique_ptr<edgevox_onnx::OfflineStream>> ss;
  std::vector<edgevox_onnx::OfflineStream *> ss_pointers;
  float duration = 0;
