// edgevox-onnx/csrc/ascend/utils.h
//
// Copyright (c)  2025  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_ASCEND_UTILS_H_
#define EDGEVOX_ONNX_CSRC_ASCEND_UTILS_H_
...
#endif  // EDGEVOX_ONNX_CSRC_ASCEND_UTILS_H_
