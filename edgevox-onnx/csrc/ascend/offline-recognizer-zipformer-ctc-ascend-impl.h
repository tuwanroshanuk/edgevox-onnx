// edgevox-onnx/csrc/ascend/offline-recognizer-zipformer-ctc-ascend-impl.h
//
// Copyright (c)  2025  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_ASCEND_OFFLINE_RECOGNIZER_ZIPFORMER_CTC_ASCEND_IMPL_H_
#define EDGEVOX_ONNX_CSRC_ASCEND_OFFLINE_RECOGNIZER_ZIPFORMER_CTC_ASCEND_IMPL_H_
...
#include "edgevox-onnx/csrc/rknn/offline-ctc-greedy-search-decoder-rknn.h"
 ...
 public:
  ...
  void Init() {
    if (config_.decoding_method == "greedy_search") {
      ...
      EDGEVOX_ONNX_LOGE("Only greedy_search is supported at present. Given %s",
...
#endif  // EDGEVOX_ONNX_CSRC_ASCEND_OFFLINE_RECOGNIZER_ZIPFORMER_CTC_ASCEND_IMPL_H_
