// edgevox-onnx/csrc/funasr-nano-tokenizer.h
//
...
#ifndef EDGEVOX_ONNX_CSRC_FUNASR_NANO_TOKENIZER_H_
#define EDGEVOX_ONNX_CSRC_FUNASR_NANO_TOKENIZER_H_
...
#endif  // EDGEVOX_ONNX_CSRC_FUNASR_NANO_TOKENIZER_H_
