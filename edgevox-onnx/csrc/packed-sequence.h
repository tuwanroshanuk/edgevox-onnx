// edgevox-onnx/csrc/packed-sequence.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_PACKED_SEQUENCE_H_
#define EDGEVOX_ONNX_CSRC_PACKED_SEQUENCE_H_
...
#endif  // EDGEVOX_ONNX_CSRC_PACKED_SEQUENCE_H_
