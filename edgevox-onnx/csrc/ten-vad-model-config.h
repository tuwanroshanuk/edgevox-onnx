// edgevox-onnx/csrc/ten-vad-model-config.h
//
// Copyright (c)  2025  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_TEN_VAD_MODEL_CONFIG_H_
#define EDGEVOX_ONNX_CSRC_TEN_VAD_MODEL_CONFIG_H_
...
#endif  // EDGEVOX_ONNX_CSRC_TEN_VAD_MODEL_CONFIG_H_
