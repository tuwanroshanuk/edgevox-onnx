// edgevox-onnx/csrc/online-conformer-transducer-model.cc
//
// Copyright (c)  2023 Jingzhao Ou (jingzhao.ou@gmail.com)

#include "edgevox-onnx/csrc/online-conformer-transducer-model.h"
...
void OnlineConformerTransducerModel::InitEncoder(void *model_data,
  ...
  EDGEVOX_ONNX_READ_META_DATA(num_encoder_layers_, "num_encoder_layers");
  EDGEVOX_ONNX_READ_META_DATA(T_, "T");
  EDGEVOX_ONNX_READ_META_DATA(decode_chunk_len_, "decode_chunk_len");
  EDGEVOX_ONNX_READ_META_DATA(left_context_, "left_context");
  EDGEVOX_ONNX_READ_META_DATA(encoder_dim_, "encoder_dim");
  EDGEVOX_ONNX_READ_META_DATA(pad_length_, "pad_length");
  EDGEVOX_ONNX_READ_META_DATA(cnn_module_kernel_, "cnn_module_kernel");
}
