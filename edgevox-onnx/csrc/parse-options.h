// edgevox-onnx/csrc/parse-options.h
//
// Copyright (c)  2022-2023  Xiaomi Corporation
//
// This file is copied and modified from kaldi/src/util/parse-options.h

#ifndef EDGEVOX_ONNX_CSRC_PARSE_OPTIONS_H_
#define EDGEVOX_ONNX_CSRC_PARSE_OPTIONS_H_
...
#endif  // EDGEVOX_ONNX_CSRC_PARSE_OPTIONS_H_
