// edgevox-onnx/csrc/offline-source-separation-spleeter-impl.h
//
// Copyright (c)  2025  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_SOURCE_SEPARATION_SPLEETER_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_SOURCE_SEPARATION_SPLEETER_IMPL_H_
...
#include "edgevox-onnx/csrc/offline-source-separation-spleeter-model.h"
...
class OfflineSourceSeparationSpleeterImpl : public OfflineSourceSeparationImpl {
 public:
  ...
  OfflineSourceSeparationOutput Process(
    ...
    if (num_frames % 512) {
      EDGEVOX_ONNX_LOGE("num_frames should be multiple of 512, actual: %d. %d",
 ...
 private:
  ...
  knf::StftResult ComputeStft(const OfflineSourceSeparationInput &input,
    ...
    if (ch >= input.samples.data.size()) {
      EDGEVOX_ONNX_LOGE("Invalid channel %d. Max %d", ch,
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_SOURCE_SEPARATION_SPLEETER_IMPL_H_
