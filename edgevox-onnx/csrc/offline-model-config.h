// edgevox-onnx/csrc/offline-model-config.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_MODEL_CONFIG_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_MODEL_CONFIG_H_

#include <string>

#include "edgevox-onnx/csrc/offline-canary-model-config.h"
...
#include "edgevox-onnx/csrc/offline-transducer-model-config.h"
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_MODEL_CONFIG_H_
