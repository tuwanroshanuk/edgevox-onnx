// edgevox-onnx/csrc/offline-tts-kokoro-impl.h
//
// Copyright (c)  2025  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_TTS_KOKORO_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_TTS_KOKORO_IMPL_H_
...
#include "edgevox-onnx/csrc/kokoro-multi-lang-lexicon.h"
...
#include "edgevox-onnx/csrc/offline-tts-kokoro-model.h"
  ...
  void InitFrontend(Manager *mgr) {
    ...
    if (meta_data.version >= 2) {
      ...
      if (config_.model.kokoro.lexicon.empty() &&
        ...
        EDGEVOX_ONNX_LOGE("Current model version: '%d'", meta_data.version);
        EDGEVOX_ONNX_LOGE(
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_TTS_KOKORO_IMPL_H_
