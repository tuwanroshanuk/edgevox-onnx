// edgevox-onnx/csrc/audio-tagging.h
//
// Copyright (c)  2024  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_AUDIO_TAGGING_H_
#define EDGEVOX_ONNX_CSRC_AUDIO_TAGGING_H_
...
#endif  // EDGEVOX_ONNX_CSRC_AUDIO_TAGGING_H_
