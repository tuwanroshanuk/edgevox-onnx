// edgevox-onnx/csrc/offline-recognizer.h
//
// Copyright (c)  2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_H_
