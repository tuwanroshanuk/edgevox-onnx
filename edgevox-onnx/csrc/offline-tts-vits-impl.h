// edgevox-onnx/csrc/offline-tts-vits-impl.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_TTS_VITS_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_TTS_VITS_IMPL_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_TTS_VITS_IMPL_H_
