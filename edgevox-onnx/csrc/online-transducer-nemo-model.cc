// edgevox-onnx/csrc/online-transducer-nemo-model.cc
//
...
class OnlineTransducerNeMoModel::Impl {
 ...
 private:
  void InitEncoder(void *model_data, size_t model_data_length) {
    ...
    EDGEVOX_ONNX_READ_META_DATA(window_size_, "window_size");
    EDGEVOX_ONNX_READ_META_DATA(chunk_shift_, "chunk_shift");
    ...
    EDGEVOX_ONNX_READ_META_DATA(cache_last_channel_dim1_,
                               "cache_last_channel_dim1");
    EDGEVOX_ONNX_READ_META_DATA(cache_last_channel_dim2_,
                               "cache_last_channel_dim2");
    EDGEVOX_ONNX_READ_META_DATA(cache_last_channel_dim3_,
                               "cache_last_channel_dim3");
    EDGEVOX_ONNX_READ_META_DATA(cache_last_time_dim1_, "cache_last_time_dim1");
    EDGEVOX_ONNX_READ_META_DATA(cache_last_time_dim2_, "cache_last_time_dim2");
    EDGEVOX_ONNX_READ_META_DATA(cache_last_time_dim3_, "cache_last_time_dim3");
