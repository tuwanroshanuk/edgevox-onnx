// edgevox-onnx/csrc/offline-recognizer-sense-voice-impl.h
//
// Copyright (c)  2022-2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_SENSE_VOICE_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_SENSE_VOICE_IMPL_H_
...
#include "edgevox-onnx/csrc/offline-ctc-greedy-search-decoder.h"
 ...
 public:
  ...
  void DecodeStreams(OfflineStream **ss, int32_t n) const override {
    ...
    if (config_.model_config.sense_voice.language.empty()) {
      ...
      EDGEVOX_ONNX_LOGE("Unknown language: %s. Use 0 instead.",
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_SENSE_VOICE_IMPL_H_
