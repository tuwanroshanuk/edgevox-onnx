// edgevox-onnx/csrc/provider-config.h
//
// Copyright (c)  2024  Uniphore (Author: Manickavela)

#ifndef EDGEVOX_ONNX_CSRC_PROVIDER_CONFIG_H_
#define EDGEVOX_ONNX_CSRC_PROVIDER_CONFIG_H_
...
#endif  // EDGEVOX_ONNX_CSRC_PROVIDER_CONFIG_H_
