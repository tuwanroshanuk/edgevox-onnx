// edgevox-onnx/csrc/online-lstm-transducer-model.cc
//
// Copyright (c)  2023  Xiaomi Corporation
#include "edgevox-onnx/csrc/online-lstm-transducer-model.h"
...
void OnlineLstmTransducerModel::InitEncoder(void *model_data,
  ...
  EDGEVOX_ONNX_READ_META_DATA(rnn_hidden_size_, "rnn_hidden_size");
  EDGEVOX_ONNX_READ_META_DATA(d_model_, "d_model");
}
