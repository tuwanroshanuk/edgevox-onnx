// edgevox-onnx/csrc/offline-stream.h
//
// Copyright (c)  2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_STREAM_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_STREAM_H_
#include <stdint.h>
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_STREAM_H_
