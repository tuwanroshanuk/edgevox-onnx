// edgevox-onnx/csrc/edgevox-onnx-keyword-spotter-microphone.cc
//
...
static int32_t RecordCallback(const void *input_buffer,
                              ...
                              void *user_data) {
  auto stream = reinterpret_cast<edgevox_onnx::OnlineStream *>(user_data);
...
Usage:
  ...
  ./bin/edgevox-onnx-keyword-spotter-microphone \
...
for a list of pre-trained models to download.
  ...
  edgevox_onnx::KeywordSpotterConfig config;
  ...
  edgevox_onnx::KeywordSpotter spotter(config);
  ...
  if (device_index == paNoDevice) {
    ...
    fprintf(stderr, " ./bin/edgevox-onnx-keyword-spotter-alsa \n");
    EDGEVOX_ONNX_EXIT(EXIT_FAILURE);
  }
