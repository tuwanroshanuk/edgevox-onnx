// edgevox-onnx/csrc/offline-tts-vits-model-meta-data.h
//
// Copyright (c)  2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_TTS_VITS_MODEL_META_DATA_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_TTS_VITS_MODEL_META_DATA_H_
...
struct OfflineTtsVitsModelMetaData {
  ...
  bool is_wfloat_emotional_vits = false;
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_TTS_VITS_MODEL_META_DATA_H_
