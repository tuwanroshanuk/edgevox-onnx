// edgevox-onnx/csrc/vad-model-config.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_VAD_MODEL_CONFIG_H_
#define EDGEVOX_ONNX_CSRC_VAD_MODEL_CONFIG_H_

#include <string>

#include "edgevox-onnx/csrc/parse-options.h"
#include "edgevox-onnx/csrc/silero-vad-model-config.h"
#include "edgevox-onnx/csrc/ten-vad-model-config.h"
...
#endif  // EDGEVOX_ONNX_CSRC_VAD_MODEL_CONFIG_H_
