// edgevox-onnx/csrc/offline-lm-config.h
//
// Copyright (c)  2023  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_LM_CONFIG_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_LM_CONFIG_H_
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_LM_CONFIG_H_
