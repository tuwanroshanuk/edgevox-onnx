// edgevox-onnx/csrc/offline-transducer-modified-beam-search-nemo-decoder.cc
//
...
#include "edgevox-onnx/csrc/packed-sequence.h"
#include "edgevox-onnx/csrc/slice.h"
...
OfflineTransducerModifiedBeamSearchNeMoDecoder::Decode(
  ...
  if (ss != nullptr) EDGEVOX_ONNX_CHECK_EQ(batch_size, n);
