// edgevox-onnx/csrc/online-websocket-server.cc
//
...
./bin/edgevox-onnx-online-websocket-server --help

./bin/edgevox-onnx-online-websocket-server \
  --port=6006 \
  --num-work-threads=5 \
...
int32_t main(int32_t argc, char *argv[]) {
  ...
  edgevox_onnx::OnlineWebsocketServerConfig config;
  ...
  edgevox_onnx::OnlineWebsocketServer server(io_conn, io_work, config);
  server.Run(port);
