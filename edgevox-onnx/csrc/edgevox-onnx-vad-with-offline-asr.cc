// edgevox-onnx/csrc/edgevox-onnx-vad-with-offline-asr.cc
//
...
Speech recognition using VAD + non-streaming models with edgevox-onnx.
...
See https://k2-fsa.github.io/sherpa/onnx/moonshine/index.html
  ...
  ./bin/edgevox-onnx-vad-with-offline-asr \
    --silero-vad-model=/path/to/silero_vad.onnx \
    --moonshine-preprocessor=/Users/fangjun/open-source/edgevox-onnx/scripts/moonshine/preprocess.onnx \
    --moonshine-encoder=/Users/fangjun/open-source/edgevox-onnx/scripts/moonshine/encode.int8.onnx \
    --moonshine-uncached-decoder=/Users/fangjun/open-source/edgevox-onnx/scripts/moonshine/uncached_decode.int8.onnx \
    --moonshine-cached-decoder=/Users/fangjun/open-source/edgevox-onnx/scripts/moonshine/cached_decode.int8.onnx \
    --tokens=/Users/fangjun/open-source/edgevox-onnx/scripts/moonshine/tokens.txt \
    --num-threads=1 \
    /path/to/foo.wav
...
for a list of pre-trained models to download.
  ...
  edgevox_onnx::OfflineRecognizerConfig asr_config;
  ...
  edgevox_onnx::OfflineRecognizer recognizer(asr_config);
  fprintf(stderr, "Recognizer created!\n");

  auto vad = std::make_unique<edgevox_onnx::VoiceActivityDetector>(vad_config);
  ...
  bool is_ok = false;
  auto samples = edgevox_onnx::ReadWave(wave_filename, &sampling_rate, &is_ok);
  if (!is_ok) {
