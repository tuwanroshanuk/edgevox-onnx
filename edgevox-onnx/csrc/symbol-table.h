// edgevox-onnx/csrc/symbol-table.h
//
// Copyright (c)  2022-2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_SYMBOL_TABLE_H_
#define EDGEVOX_ONNX_CSRC_SYMBOL_TABLE_H_
...
#endif  // EDGEVOX_ONNX_CSRC_SYMBOL_TABLE_H_
