// edgevox-onnx/csrc/keyword-spotter.h
//
// Copyright (c)  2023-2024  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_KEYWORD_SPOTTER_H_
#define EDGEVOX_ONNX_CSRC_KEYWORD_SPOTTER_H_
...
#endif  // EDGEVOX_ONNX_CSRC_KEYWORD_SPOTTER_H_
