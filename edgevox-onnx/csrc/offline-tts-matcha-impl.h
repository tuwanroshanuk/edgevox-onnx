// edgevox-onnx/csrc/offline-tts-matcha-impl.h
//
// Copyright (c)  2024  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_TTS_MATCHA_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_TTS_MATCHA_IMPL_H_
...
#include "edgevox-onnx/csrc/character-lexicon.h"
#include "edgevox-onnx/csrc/fst-utils.h"
#include "edgevox-onnx/csrc/lexicon.h"
#include "edgevox-onnx/csrc/macros.h"
#include "edgevox-onnx/csrc/matcha-tts-lexicon.h"
#include "edgevox-onnx/csrc/melo-tts-lexicon.h"
...
#include "edgevox-onnx/csrc/offline-tts-matcha-model.h"
  ...
  explicit OfflineTtsMatchaImpl(const OfflineTtsConfig &config)
    ...
    if (meta_data.need_vocoder) {
      if (config.model.matcha.vocoder.empty()) {
        EDGEVOX_ONNX_LOGE("Please provide vocoder for this model");
        EDGEVOX_ONNX_EXIT(-1);
      }

      if (!FileExists(config.model.matcha.vocoder)) {
        EDGEVOX_ONNX_LOGE("Please vocoder '%s' does not exist",
 ...
 private:
  ...
  void InitFrontend(Manager *mgr) {
    ...
    if (meta_data.is_zh_en) {
      ...
      EDGEVOX_ONNX_LOGE("Unsupported matcha tts model. Please ask for help");
      EDGEVOX_ONNX_EXIT(-1);
    }
  }
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_TTS_MATCHA_IMPL_H_
