// edgevox-onnx/csrc/audio-tagging-zipformer-impl.h
//
// Copyright (c)  2024  Xiaomi Corporation
#ifndef EDGEVOX_ONNX_CSRC_AUDIO_TAGGING_ZIPFORMER_IMPL_H_
#define EDGEVOX_ONNX_CSRC_AUDIO_TAGGING_ZIPFORMER_IMPL_H_
...
#include "edgevox-onnx/csrc/audio-tagging-label-file.h"
#include "edgevox-onnx/csrc/audio-tagging.h"
#include "edgevox-onnx/csrc/macros.h"
#include "edgevox-onnx/csrc/math.h"
#include "edgevox-onnx/csrc/offline-zipformer-audio-tagging-model.h"
 ...
 public:
  explicit AudioTaggingZipformerImpl(const AudioTaggingConfig &config)
    ...
    if (model_.NumEventClasses() != labels_.NumEventClasses()) {
      EDGEVOX_ONNX_LOGE("number of classes: %d (model) != %d (label file)",
...
#endif  // EDGEVOX_ONNX_CSRC_AUDIO_TAGGING_ZIPFORMER_IMPL_H_
