// edgevox-onnx/csrc/offline-speech-denoiser-impl.cc
//
...
#include "edgevox-onnx/csrc/offline-speech-denoiser-dpdfnet-impl.h"
#include "edgevox-onnx/csrc/offline-speech-denoiser-gtcrn-impl.h"
...
std::unique_ptr<OfflineSpeechDenoiserImpl> OfflineSpeechDenoiserImpl::Create(
  ...
  EDGEVOX_ONNX_LOGE("Please provide one speech denoising model.");
  return nullptr;
}
