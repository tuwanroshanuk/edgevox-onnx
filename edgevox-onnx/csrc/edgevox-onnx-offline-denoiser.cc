// edgevox-onnx/csrc/edgevox-onnx-offline-denoiser.cc
//
...
./bin/edgevox-onnx-offline-denoiser \
  ...
  edgevox_onnx::OfflineSpeechDenoiserConfig config;
  ...
  edgevox_onnx::OfflineSpeechDenoiser denoiser(config);
  ...
  fprintf(stderr, "Done\n");
  is_ok = edgevox_onnx::WriteWave(output_wave, result.sample_rate,
