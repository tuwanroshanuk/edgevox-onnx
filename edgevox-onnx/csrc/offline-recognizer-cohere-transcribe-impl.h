// edgevox-onnx/csrc/offline-recognizer-cohere-transcribe-impl.h
//
// Copyright (c)  2022-2023  Xiaomi Corporation

#ifndef EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_COHERE_TRANSCRIBE_IMPL_H_
#define EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_COHERE_TRANSCRIBE_IMPL_H_
...
#include "edgevox-onnx/csrc/offline-cohere-transcribe-decoder.h"
#include "edgevox-onnx/csrc/offline-cohere-transcribe-greedy-search-decoder.h"
#include "edgevox-onnx/csrc/offline-cohere-transcribe-model.h"
...
class OfflineRecognizerCohereTranscribeImpl : public OfflineRecognizerImpl {
 ...
 private:
  void DecodeStream(OfflineStream *s) const {
    ...
    if (language.empty()) {
      EDGEVOX_ONNX_LOGE("Please specify a language for Cohere Transcribe");
      return;
    }
...
#endif  // EDGEVOX_ONNX_CSRC_OFFLINE_RECOGNIZER_COHERE_TRANSCRIBE_IMPL_H_
