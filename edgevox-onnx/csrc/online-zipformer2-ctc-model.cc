// edgevox-onnx/csrc/online-zipformer2-ctc-model.cc
//
// Copyright (c)  2023  Xiaomi Corporation

#include "edgevox-onnx/csrc/online-zipformer2-ctc-model.h"
 ...
 public:
  explicit Impl(const OnlineModelConfig &config)
    ...
    sess_ = std::make_unique<Ort::Session>(
        env_, EDGEVOX_ONNX_TO_ORT_PATH(config.zipformer2_ctc.model), sess_opts_);
    Init(nullptr, 0);
  }
