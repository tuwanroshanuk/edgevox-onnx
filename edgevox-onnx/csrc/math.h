...
#ifndef EDGEVOX_ONNX_CSRC_MATH_H_
#define EDGEVOX_ONNX_CSRC_MATH_H_
...
// logf(FLT_EPSILON)
#define EDGEVOX_ONNX_MIN_LOG_DIFF_FLOAT -15.9423847198486328125f

// log(DBL_EPSILON)
#define EDGEVOX_ONNX_MIN_LOG_DIFF_DOUBLE \
...
struct LogAdd<double> {
  double operator()(double x, double y) const {
    ...
    if (diff >= EDGEVOX_ONNX_MIN_LOG_DIFF_DOUBLE) {
      double res;
...
#endif  // EDGEVOX_ONNX_CSRC_MATH_H_
