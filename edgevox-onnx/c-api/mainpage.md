# edgevox-onnx public API documentation
...
These headers expose the main edgevox-onnx inference features for native
...
- objects created by `EdgevoxOnnxCreate*()` are usually destroyed with a
  matching `EdgevoxOnnxDestroy*()`
