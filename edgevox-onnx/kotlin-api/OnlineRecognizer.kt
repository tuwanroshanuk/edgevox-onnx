...
fun getModelConfig(type: Int): OnlineModelConfig? {
    when (type) {
        ...
        1000 -> {
            val modelDir = "edgevox-onnx-rk3588-streaming-zipformer-bilingual-zh-en-2023-02-20"
            return OnlineModelConfig(
                transducer = OnlineTransducerModelConfig(
        ...
        1001 -> {
            val modelDir = "edgevox-onnx-rk3588-streaming-zipformer-small-bilingual-zh-en-2023-02-16"
            return OnlineModelConfig(
                transducer = OnlineTransducerModelConfig(
                    encoder = "$modelDir/encoder.rknn",
                    decoder = "$modelDir/decoder.rknn",
